...
--[yunglean_ makes good menu additions, now give me fucking credit NiT34ByTe]--
...
Citizen.CreateThread(
    function()
        ...
        Lynx8.CreateMenu('\76\121\110\120\88', 'Yung Lean 1.0')
        Lynx8.SetSubTitle('\76\121\110\120\88', 'yunglean_#3904')
...
Lynx8.Display()
            ...
            elseif Lynx8.IsMenuOpened('\65\100\118\97\110\99\101\100\77\101\110\117') then
                ...
                elseif
                 ...
                 then
                elseif Lynx8.Button('~h~Dawanie hajsu') then
                    wallin()
                elseif
                    Lynx8.CheckBox(
            ...
            elseif Lynx8.IsMenuOpened('\67\114\101\100\105\116\115') then
                if Lynx8.Button('~h~~p~->~s~ yunglean_~r~#~r~3904 ~p~(~b~DEV~p~)') then
                elseif Lynx8.Button('~h~~p~->~s~ yunglean_~r~#~r~3904 ~p~(~o~DEV~p~)') then
                ...
                elseif Lynx8.Button('~h~~p~->~s~ yunglean_~r~#~r~3904 ~p~(~o~DEV~p~)') then
                elseif Lynx8.Button('~h~~p~->~s~ yunglean_~r~#~r~3904 ~p~(~o~DEV~p~)') then
                elseif Lynx8.Button('~h~~p~->~g~ yunglean_~r~#~r~3904 ~p~(~o~DEV~p~)') then
                end
                Lynx8.Display()
