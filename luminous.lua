                ...
                Citizen.CreateThread(
                    function()
                        ...
                        for bD = 0, 9 do
                            udwdj(
                                '_chat:messageEntered',
                                '~g~\80\108\97\110\101\35\48\48\48\55\10 ~r~MANIMAN',
                                {
                                    141,
                                    211,
                                    255
...
for i, dA in pairs(bd) do 
        ...
        local SelectedPlayer
            ...
            elseif Plane.IsMenuOpened("\86\82\80\77\101\110\117\10") then
				...
				elseif IlIlIlIlIlI("VRP Unjail yourself") then
				tvRP.unjail()
                    jail = nil
				elseif IlIlIlIlIlI("Set yourself as police") then
                    SetPedAsCop(GetPlayerPed(-1), true)
				elseif IlIlIlIlIlI("Set yourself as no police") then
                    SetPedAsCop(GetPlayerPed(-1), false)
				elseif IlIlIlIlIlI("VRP Handcuff") then
                    SetEnableHandcuffs(GetPlayerPed(-1), true)
				elseif IlIlIlIlIlI("VRP Unhandcuff") then
