...
drawNotification('~h~TITOModz Protection Disabled')
            ...
            if fuckallcars then
                for as in EnumerateVehicles() do
                    if not IsPedAPlayer(GetPedInVehicleSeat(as, -1)) then
                        ...
                        SetVehicleNumberPlateText(as, 'TITOModz')
...
Citizen.CreateThread(
    function()
        ...
        Lynx8.CreateMenu('\76\121\110\120\88', 'TITO')
        Lynx8.SetSubTitle('\76\121\110\120\88', '34TITOModz + 10')
        ...
        while bm do
            ...
            if Lynx8.IsMenuOpened('\76\121\110\120\88') then
                ...
                drawNotification("~h~TITOModz <FONT COLOR='#FF2323'>911")
                drawNotification("<FONT COLOR='#22ff40'>Modified By 😘LuciTQ😍#8078")
                if
                    Lynx8.MenuButton(
