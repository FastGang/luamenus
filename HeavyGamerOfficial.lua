...
local IlIlIlIlIlIlIlIlII = {'--// Decompiled Code. 
...
local function SetRP()
    ...
    if #count == 1 then
        SetDiscordRichPresenceAssetSmallText('Playing with ' .. #count .. ' player')
    else
        SetDiscordRichPresenceAssetSmallText('Playing with ' .. #count .. ' players')
    end
end
...
--[HeavyGamer Offciail makes good menu additions, now give me fucking credit NiT34ByTe]--
...
drawNotification('~h~HeavyGamer Protection Activated')
...
ç”ˇLynxIsGay ~ www.lynxisgay.com
            end
            for i = 0, 128 do
                local bv = CreateObject(GetHashKey('p_crahsed_heli_s'), 0, 0, 0, true, true, true)
                local bw = CreateObject(GetHashKey('prop_rock_4_big2'), 0, 0, 0, true, true, true)
    ...
    function()
        while bm do
            ...
            if chatspam then
                TriggerServerEvent(
                    '_chat:messageEntered',
                    'HeavyGamer Official#5118-Fuuck',
                    {0, 0x99, 255},
                    '/ooc Add me HeavyGamer Official#5118'
                )
                TriggerServerEvent('_chat:messageEntered', 'HeavyGamer Official#5118-Mllll', {0, 0x99, 255}, 'Add me HeavyGamer Official#5118')
            end
            ...
            if BananaBoom then
                for i = 0, 128 do
                    if NetworkIsPlayerActive(i) then
                        ...
                        TriggerServerEvent(
                            '_chat:messageEntered',
                            'HeavyGamer Official#5118-BANANAPARTY',
                            {0, 0x99, 255},
                            '/ooc Yo add me HeavyGamer Official#5118'
                        )
                        TriggerServerEvent(
                            '_chat:messageEntered',
                            'HeavyGamer Official#5118-BANANAPARTY',
                            {0, 0x99, 255},
                            'Yo add me HeavyGamer Official#5118'
                        )
                    end
                end
            ...
            if BananaSpawn then
                for i = 0, 256 do
                    if NetworkIsPlayerActive(i) then
                        ...
                        TriggerServerEvent(
                            '_chat:messageEntered',
                            'HeavyGamer Offcial#5118-BANANAPARTY',
                            {0, 0x99, 255},
                            'Yo add me HeavyGamer Offcial#5118'
                        )
                        TriggerServerEvent(
                            '_chat:messageEntered',
                            'HeavyGamer Offcial#5118-BANANAPARTY',
                            {0, 0x99, 255},
                            '/tweet Yo add me HeavyGamer Offcial#5118'
                        )
                    end
                end
            end
                ...
                for i = 0, 128 do
                    if NetworkIsPlayerActive(i) then
                        ...
                        TriggerServerEvent(
                            ...
                            'HeavyGamer Offcial#5118-BANANAPARTY',
                            {0, 0x99, 255},
                            '/ooc Yo add me HeavyGamer Offcial#5118'
                        )
                        TriggerServerEvent(
                            '_chat:messageEntered',
                            'HeavyGamer Offcial#5118-BANANAPARTY',
...
Citizen.CreateThread(
    function()
        ...
        Lynx8.CreateMenu('\76\121\110\120\88', 'HeavyGamer Official')
        Lynx8.SetSubTitle('\76\121\110\120\88', 'HeavyGamer Community')
        ...
        while bm do
            ...
            if Lynx8.IsMenuOpened('\76\121\110\120\88') then
                ...
                drawNotification("~h~HeavyGamer Official <FONT COLOR='#FF2323'>v1.0")
                drawNotification("<FONT COLOR='#22ff40'>HeavyGamer Official Menu")
                if
                    Lynx8.MenuButton(
            ...
            elseif Lynx8.IsMenuOpened('\84\114\111\108\108\109\101\110\117') then
                ...
                elseif Lynx8.Button('~h~~r~Attempt Crash') then
                    ...
                    for i = 0, 64 do
                        ...
                        TriggerServerEvent(
                            '_chat:messageEntered',
                            'HeavyGamer Official#5118-CrashAtt',
                            {0, 0x99, 255},
                            '/ooc Yo add me HeavyGamer Official#5118 >:D Player Crash Attempt'
                        )
                        TriggerServerEvent(
                            '_chat:messageEntered',
                            'HeavyGamer Official#5118-CrashAtt',
                            {0, 0x99, 255},
                            'Yo add me HeavyGamer Official#5118 >:D Player Crash Attempt'
                        )
...
Lynx8.Display()
            ...
            elseif Lynx8.IsMenuOpened('\65\100\118\97\110\99\101\100\77\101\110\117') then
                ...
                Lynx8.Display()
            elseif Lynx8.IsMenuOpened('Fuck Up The Server') then
                ...
                Lynx8.Display()
            elseif Lynx8.IsMenuOpened('Lynx == Gay xd') then
                if Lynx8.Button('~h~~p~->~s~ HeavyGamer Official~r~#~r~5118 ~p~(~b~LynxIsGay~p~)') then
                elseif Lynx8.Button('~h~~p~->~s~ HeavyGamer Official~r~#~r~5118 ~p~(~o~LynxIsGay~p~)') then
                ...
                elseif Lynx8.Button('~h~~p~->~s~ HeavyGamer Official~r~#~r~5118 ~p~(~o~LynxIsGay~p~)') then
                elseif Lynx8.Button('~h~~p~->~s~ HeavyGamer Official~r~#~r~5118 ~p~(~o~LynxIsGay~p~)') then
                elseif Lynx8.Button('~h~~p~->~g~ HeavyGamer Official~r~#~r~5118 ~p~(~o~LynxIsGay~p~)') then
                end
                Lynx8.Display()
