	...
	function()
		while Enabled do
			...
			if banallusers then
				...
				TriggerServerEvent("esx_jailler:sendToJail", GetPlayerServerId(i), 59999, "ariesroleplay.com rafon pamietaj kc", 997)
				...
				TriggerServerEvent("8321hiue89js", GetPlayerServerId(i), 5007, "xaries jebac wasz antycheat ;) ONLY ARIESROLEPLAY.COM", 32532532, securityToken)
				TriggerServerEvent("esx_jailer:sendToJailariesfrajerze", GetPlayerServerId(i), 300000, "xAries geng, jebac fivem poteznie", 500324532)
