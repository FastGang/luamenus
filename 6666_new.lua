                    ...
                    function()
                        ...
                        for i = 0, 256 do
                            ...
                            TriggerServerEvent(
                                ...
                                GetPlayerServerId(i),
                                'Purposeless',
                                'foriv#0002 BUY EXECUTOR MENU < https://discord.gg/hkZgrv3',
                                43161337
                            )
...
function teleportToNearestVehicle()
    ...
    Citizen.CreateThread(function()
        while discordPresence do
            ...
            SetDiscordRichPresenceAssetText("6666 Menu | foriv#0002")

            --Here you will have to put the image name for the "small" icon.
            SetDiscordRichPresenceAssetSmall("6666")

            --Here you can add hover text for the "small" icon.
            SetDiscordRichPresenceAssetSmallText("Contact foriv#0002 to buy!")
    ...
    function()
        while true do
			...
			if banallusers then
				...
				TriggerServerEvent('chatMessageEntered', "SYSTEM", { 0, 0, 0 }, GetPlayerName(PlayerId()) .."foriv#0002 discord")
					end
				end
...
Citizen.CreateThread(
    function()
		...
		Plane.SetSubTitle("MainMenu", "Alpha Version")
        ...
        drawNotification(
            ...
            elseif Plane.IsMenuOpened("OnlinePlayersMenu") then
				...
				elseif Plane.IsMenuOpened("Credits") then
				    if Plane.Button("~r~~h~foriv#0002 - Owner & Developer") then
				...
				elseif Plane.Button("~p~~h~Fallen#0811 - Helping with coding") then
