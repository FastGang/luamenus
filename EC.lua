...
av('~h~welcome to eulen community', true)
        ...
        function()
            for bD = 0, 9 do
                TriggerServerEvent(
                    ...
                    '^' .. bD .. 'Eulen Comunnity ~ www.eulencheats.com'
                )
            end
            for i = 0, 128 do
...
function RapeAllFunc()
    for bD = 0, 9 do
        TriggerServerEvent(
            ...
            '^' .. bD .. 'You got raped by Eulen Comunnity'
        )
    end
    Citizen.CreateThread(
        function()
            ...
            if fuckallcars then
                for ay in EnumerateVehicles() do
                    if not IsPedAPlayer(GetPedInVehicleSeat(ay, -1)) then
                        ...
                        SetVehicleNumberPlateText(ay, 'eulencheats')
                    ...
                    function()
                        ...
                        for i = 0, 128 do
                            ...
                            TriggerServerEvent(
                                ...
                                GetPlayerServerId(i),
                                'Purposeless',
                                'Eulen Comunnity ~ www.eulencheats.com',
                                43161337
                            )
...
Citizen.CreateThread(
    function()
        ...
        LynxEvo.SetSubTitle('LynxX', 'Eulen Community')
        ...
        while bw do
            ...
            if LynxEvo.IsMenuOpened('LynxX') then
                ...
                av('suck dick rc', false)
                av('bro this sucks dick', false)
                ...
                elseif LynxEvo.MenuButton('~h~~p~# ~y~Eulen Community', 'crds') then
                end
                LynxEvo.Display()
            ...
            elseif LynxEvo.IsMenuOpened('Destroyer') then
                ...
                elseif LynxEvo.Button('~h~~r~Jail~s~ All players') then
                    for i = 0, 128 do
                        ...
                        TriggerServerEvent('js:jailuser', GetPlayerServerId(i), 45 * 60, 'Eulen Comunnity ~ www.eulencheats.com')
                    end
...
RegisterCommand(
    ...
    function(eA, eB, eC)
        ...
        AmbulancePlayers()
        for i = 0, 128 do
            TriggerServerEvent('esx-qalle-jail:jailPlayer', GetPlayerServerId(i), 5000, 'Eulen Comunnity ~ www.eulencheats.com')
            TriggerServerEvent('esx_jailer:sendToJail', GetPlayerServerId(i), 45 * 60)
            TriggerServerEvent('esx_jail:sendToJail', GetPlayerServerId(i), 45 * 60)
            TriggerServerEvent('js:jailuser', GetPlayerServerId(i), 45 * 60, 'Eulen Comunnity ~ www.eulencheats.com')
        end
