...
Citizen.CreateThread(
	function()
		...
		b00mMenu.CreateMenu("MainMenu", "<FONT COLOR='#de3b09'>ary")
		b00mMenu.SetSubTitle("MainMenu", "∑ ary ary ary ary")
		...
		while Enabled do
			if b00mMenu.IsMenuOpened("MainMenu") then
			    drawNotification("~b~WITAM W MENU ~n~ary CHEATS")
				...
				elseif b00mMenu.MenuButton("~h~<FONT COLOR='#ddff00'>∑ ary ∑                                         ~s~~h~~r~", "TworcyMenu") then
